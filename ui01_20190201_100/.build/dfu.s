	.text
	.file	"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc"
	...
	.set usage.anon.27,0
	.set usage.anon.28,0
	.globread DFUReportResetState,usage.anon.15,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:358:47: note: object used here\n            if (currentTime - DFUTimerStart > DFUResetTimeout)\n                                              ^~~~~~~~~~~~~~~"
	.globread DFUReportResetState,usage.anon.14,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:358:31: note: object used here\n            if (currentTime - DFUTimerStart > DFUResetTimeout)\n                              ^~~~~~~~~~~~~"
	.globread usage.anon.19,usage.anon.20,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:267:52: note: object used here\n    data_buffer[0] = timeout << 8 | (unsigned char)DFU_status;\n                                                   ^~~~~~~~~~"
	.globwrite DFUDeviceRequests,usage.anon.24,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:557:5: note: object used here\n    g_DFU_state = dfuState;\n    ^~~~~~~~~~~"
	.globwrite usage.anon.25,usage.anon.13,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:402:5: note: object used here\n    DFUTimer :> s;\n    ^~~~~~~~"
	.globwrite DFUReportResetState,usage.anon.13,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:357:13: note: object used here\n            DFUTimer :> currentTime;\n            ^~~~~~~~"
	.globwrite DFUReportResetState,usage.anon.24,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:347:9: note: object used here\n        g_DFU_state = STATE_DFU_IDLE;\n        ^~~~~~~~~~~"
	.globwrite usage.anon.18,usage.anon.17,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:232:9: note: object used here\n        subPagesLeft = 0;\n        ^~~~~~~~~~~~"
	.globwrite usage.anon.16,usage.anon.17,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:186:13: note: object used here\n            subPagesLeft = 4;\n            ^~~~~~~~~~~~"
	.globwrite usage.anon.12,usage.anon.15,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:96:9: note: object used here\n        DFUResetTimeout = timeout * 100000;\n        ^~~~~~~~~~~~~~~"
	.globwrite usage.anon.12,usage.anon.14,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:99:21: note: object used here\n        DFUTimer :> DFUTimerStart;\n                    ^~~~~~~~~~~~~"
	.globwrite usage.anon.12,usage.anon.13,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:99:9: note: object used here\n        DFUTimer :> DFUTimerStart;\n        ^~~~~~~~"
	.globwrite usage.anon.11,usage.anon.10,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:82:9: note: object used here\n        DFU_flash_connected = 0;\n        ^~~~~~~~~~~~~~~~~~~"
	.globwrite usage.anon.9,usage.anon.10,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:69:6: note: object used here\n        DFU_flash_connected = 1;\n        ^~~~~~~~~~~~~~~~~~~"
	...
	.assert 1,usage.anon.28.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:519:43: error: call to function `XMOS_DFU_LoadState\' which selects on a notification in a combinable function select case\n                        return_data_len = XMOS_DFU_LoadState();\n                                          ^~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.27.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:514:43: error: call to function `XMOS_DFU_SaveState\' which selects on a notification in a combinable function select case\n                        return_data_len = XMOS_DFU_SaveState();\n                                          ^~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.26.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:509:43: error: call to function `XMOS_DFU_SelectImage\' which selects on a notification in a combinable function select case\n                        return_data_len = XMOS_DFU_SelectImage(sp.wValue, c_user_cmd);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.25.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:493:43: error: call to function `XMOS_DFU_RevertFactory\' which selects on a notification in a combinable function select case\n                        return_data_len = XMOS_DFU_RevertFactory(c_user_cmd);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.23.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:483:43: error: call to function `DFU_Abort\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_Abort(tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.22.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:477:43: error: call to function `DFU_GetState\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_GetState(sp.wLength, data_out, c_user_cmd, tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.21.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:472:43: error: call to function `DFU_ClrStatus\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_ClrStatus(tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.19.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:466:43: error: call to function `DFU_GetStatus\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_GetStatus(sp.wLength, data_out, c_user_cmd, tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.18.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:459:43: error: call to function `DFU_Upload\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_Upload(sp.wLength, sp.wValue, data_out, tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.16.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:454:37: error: call to function `DFU_Dnload\' which selects on a notification in a combinable function select case\n                        returnVal = DFU_Dnload(sp.wLength, sp.wValue, data, c_user_cmd, return_data_len, tmpDfuState);\n                                    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.assert 1,usage.anon.12.actnonotificationselect,"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:446:43: error: call to function `DFU_Detach\' which selects on a notification in a combinable function select case\n                        return_data_len = DFU_Detach(sp.wValue, c_user_cmd, tmpDfuState);\n                                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
.Ldebug_range:
	.file	1 "F:/Projects/UI-01_sw1_hw1/module_dfu/src\\dfu.xc"
...
.Lfunc_begin1:
	.loc	1 432 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:432:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
	DUALENTSP_lu6 74
...
.Lxtalabel0:
	...
	.loc	1 436 0 prologue_end    # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:436:0
.Ltmp13:
	stw r5, sp[67]
	.loc	1 438 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:438:0
.Ltmp14:
	stw r0, sp[66]
	{
		mkmsk r2, 2
...
.Ltmp15:
	ldc r2, 239
	.loc	1 442 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:442:0
	{
		lss r2, r2, r3
		nop
	}
...
.Lxtalabel3:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:dfuState <- R0
	.loc	1 445 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:445:0
	stw r0, sp[66]
	.loc	1 446 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:446:0
	{
		ldc r5, 0
		nop
	}
	.loc	1 89 5                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:89:5
.Ltmp19:
	bf r0, .LBB1_10
.Ltmp20:
# BB#14:                                # %iffalse.i
.Lxtalabel4:
	...
	.loc	1 103 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:103:0
.Ltmp21:
	stw r0, sp[66]
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:p <- R4
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
...
.Lxtalabel5:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer <- R7
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	.loc	1 453 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:453:0
	{
		lsu r0, r5, r9
		nop
	}
...
.Ltmp24:
	#DEBUG_VALUE: i <- R5
	.loc	1 452 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:452:0
	{
		add r5, r5, 1
		ldc r0, 16
	}
...
.Lxtalabel6:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:sp <- R1
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	.loc	1 454 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:454:0
	{
		add r0, r1, 8
		ldc r6, 0
	}
...
.Lxtalabel9:
	...
	.loc	1 489 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:489:0
	stw r5, sp[67]
	{
		mkmsk r6, 1
		mov r2, r5
...
.Lxtalabel10:
	...
	.loc	1 459 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:459:0
	{
		add r0, r1, 8
		ldc r6, 0
	}
...
.Lxtalabel11:
	...
	#DEBUG_VALUE: data_out <- [SP+136]
	#DEBUG_VALUE: i <- 0
	.loc	1 461 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:461:0
	{
		lsu r2, r1, r9
		nop
	}
.Ltrap_info1:
	...
	.loc	1 461 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:461:0
	stw r2, r7[r1]
	.loc	1 460 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:460:0
	{
		add r1, r1, 1
		nop
	}
...
.Lxtalabel12:
	...
	.loc	1 267 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:267:0
.Ltmp43:
	{
		eq r1, r0, 6
		stw r6, sp[18]
	}
	.loc	1 269 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:269:0
	bt r1, .LBB1_23
.Ltmp44:
# BB#19:                                # %switchcase55
.Lxtalabel13:
...
.Lxtalabel16:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:dfuState <- R0
	.loc	1 298 5                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:298:5
	{
		eq r0, r0, 10
		nop
	}
.Ltmp49:
	.loc	1 300 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:300:0
	bt r0, .LBB1_31
.Ltmp50:
# BB#32:                                # %switchcase92
.Lxtalabel17:
...
.Lxtalabel18:
	...
	.loc	1 311 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:311:0
	{
		ldc r1, 8
		stw r0, sp[2]
	}
	.loc	1 313 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:313:0
	{
		lsu r1, r1, r0
		nop
	}
...
.Lxtalabel20:
	...
	.loc	1 318 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:318:0
	stw r0, sp[66]
.Ltmp55:
...
.Lxtalabel21:
	...
	.loc	1 477 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:477:0
	stw r5, sp[67]
.Ltmp56:
	#DEBUG_VALUE: i <- 0
	{
...
.Lxtalabel22:
	...
	#DEBUG_VALUE: data_out <- [SP+8]
	#DEBUG_VALUE: i <- 0
	.loc	1 479 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:479:0
	{
		lsu r3, r2, r9
		nop
	}
...
.Ltmp60:
	.loc	1 479 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:479:0
	stw r3, r7[r2]
	.loc	1 478 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:478:0
	{
		add r2, r2, 1
		nop
	}
...
.Lxtalabel24:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	#DEBUG_VALUE: s <- 0
	.loc	1 398 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:398:0
	{
		ldc r5, 0
		nop
	}
...
.Lxtalabel25:
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	#DEBUG_VALUE: s <- 0
	.loc	1 62 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:62:0
.Lxta.call_labels2:
	bl DFUCustomFlashEnable
.Ltmp65:
	.loc	1 63 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:63:0
.Lxta.call_labels3:
	bl flash_cmd_init
.Ltmp66:
...
.LBB1_44:                               # %DFU_OpenFlash.exit211
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	#DEBUG_VALUE: s <- 0
	.loc	1 400 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:400:0
.Lxta.call_labels4:
	bl flash_cmd_erase_all
.Ltmp69:
	#DEBUG_VALUE: s <- R0
	.loc	1 402 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:402:0
	{
		gettime r0
		get r11, id
	}
.Ltmp70:
	.loc	1 403 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:403:0
	ldaw r1, dp[__timers]
	{
		nop
		ldw r1, r1[r11]
...
.Lxtalabel27:
	...
	.loc	1 499 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:499:0
	stw r5, sp[67]
	ldw r2, cp[.LCPI1_1]
	{
		mkmsk r6, 1
...
.Lxtalabel28:
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:p <- R4
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	.loc	1 304 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:304:0
	stw r0, sp[66]
.Ltmp75:
...
.Ltmp78:
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:p <- R4
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[66]
	{
		mkmsk r1, 1
		nop
...
.Lxtalabel32:
	...
	.loc	1 91 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:91:0
.Ltmp81:
	stw r7, sp[66]
	.loc	1 93 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:93:0
	{
		ldc r8, 0
		nop
	}
...
.LBB1_13:                               # %DFU_OpenFlash.exit
	...
	#DEBUG_VALUE: _i.i_dfu.DFUHandler._c0.HandleDfuRequest:data_buffer_length <- R3
	ldw r0, cp[.LCPI1_3]
	.loc	1 96 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:96:0
	mul r0, r6, r0
	.loc	1 96 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:96:0
	stw r0, dp[DFUResetTimeout]
	.loc	1 99 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:99:0
	{
		gettime r0
		nop
	}
...
.Lxtalabel37:
	.loc	1 284 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:284:0
	stw r0, sp[66]
.Ltmp91:
...
.Lxtalabel38:
	...
	.loc	1 466 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:466:0
	stw r2, sp[67]
.Ltmp92:
	#DEBUG_VALUE: i <- 0
	{
...
.Lxtalabel39:
	...
	#DEBUG_VALUE: data_out <- [SP+72]
	#DEBUG_VALUE: i <- 0
	.loc	1 468 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:468:0
	{
		lsu r11, r3, r9
		nop
	}
.Ltrap_info3:
	...
	.loc	1 468 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:468:0
	stw r11, r7[r3]
	.loc	1 467 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:467:0
	{
		add r3, r3, 1
		nop
	}
...
DFUDelay:                               # @DFUDelay
.Lfunc_begin12:
	.loc	1 49 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:49:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel160:
...
.Ltmp402:
	.loc	1 53 0 prologue_end     # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:53:0
	{
		get r11, id
		nop
	}
	.loc	1 53 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:53:0
	ldaw r2, dp[__timers]
	.loc	1 53 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:53:0
	{
		add r0, r1, r0
...
.Lfunc_begin13:
	.loc	1 109 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:109:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel161:
...
.Ltmp415:
	...
	.loc	1 118 5 prologue_end    # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:118:5
.Ltmp416:
	{
		ldc r8, 0
		nop
...
.Lxtalabel163:
	...
	.loc	1 118 5                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:118:5
	st8 r0, r7[r8]
.LBB13_3:                               # %ifdone
.Lxtalabel164:
	#DEBUG_VALUE: fromDfuIdle <- 0
	...
	.loc	1 123 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:123:0
	{
		eq r9, r0, 2
		nop
	}
...
.Lxtalabel168:
	...
	.loc	1 129 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:129:0
	{
		mkmsk r0, 1
		stw r0, r7[0]
	}
...
.Lxtalabel169:
	#DEBUG_VALUE: fromDfuIdle <- 0
	.loc	1 147 5                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:147:5
	bf r6, .LBB13_9
# BB#13:                                # %iffalse27
.Lxtalabel170:
	#DEBUG_VALUE: fromDfuIdle <- 0
...
.Lxtalabel171:
	...
	#DEBUG_VALUE: cmd_data <- [SP+8]
	#DEBUG_VALUE: s <- 0
	.loc	1 178 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:178:0
.Lxta.call_labels30:
	bl flash_cmd_erase_all
.Ltmp423:
.LBB13_15:                              # %ifdone48
.Lxtalabel172:
	...
	#DEBUG_VALUE: flash_page_index <- 0
	#DEBUG_VALUE: cmd_data <- [SP+8]
	.loc	1 182 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:182:9
	{
		zext r5, 2
		nop
	}
...
.Lxtalabel173:
	...
	.loc	1 184 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:184:0
	xor r0, r9, r0
	.loc	1 184 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:184:0
	{
		ldaw r0, sp[2]
	...
	ldc r1, 64
	.loc	1 185 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:185:0
.Lxta.call_labels31:
	...
	.loc	1 186 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:186:0
...
.Lxtalabel174:
	...
	#DEBUG_VALUE: flash_page_index <- 0
	#DEBUG_VALUE: cmd_data <- [SP+8]
	.loc	1 191 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:191:0
	{
		ldaw r1, sp[2]
		ldw r0, r4[r8]
	}
	.loc	1 191 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:191:0
	stw r0, r1[r8]
	.loc	1 189 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:189:0
	{
		add r8, r8, 1
		nop
	}
...
.Lxtalabel175:
	...
	ldc r1, 64
	.loc	1 194 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:194:0
.Lxta.call_labels32:
	bl flash_cmd_write_page_data
	.loc	1 195 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:195:0
...
.Lxtalabel176:
	...
	.loc	1 152 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:152:9
	ldw r0, dp[subPagesLeft]
	bf r0, .LBB13_12
.Ltmp429:
...
.Lxtalabel177:
	...
	ldc r6, 64
	.loc	1 154 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:154:0
.Ltmp430:
	{
		mov r0, r4
		mov r1, r5
...
.Lxtalabel178:
	...
	#DEBUG_VALUE: cmd_data <- [SP+136]
	#DEBUG_VALUE: subPagePad <- [SP+72]
	.loc	1 157 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:157:0
	{
		mov r0, r4
		mov r1, r6
	}
.Lxta.call_labels33:
	bl flash_cmd_write_page_data
	.loc	1 155 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:155:0
	{
		add r5, r5, 1
		nop
	}
...
.Lxtalabel179:
	...
	.loc	1 161 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:161:0
	{
		ldaw r0, sp[34]
		stw r0, sp[34]
	}
	ldc r1, 64
	.loc	1 162 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:162:0
.Lxta.call_labels34:
	bl flash_cmd_write_page
	{
		ldc r0, 6
...
.Lxtalabel180:
	#DEBUG_VALUE: fromDfuIdle <- 0
	.loc	1 197 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:197:0
	{
		ldc r0, 0
		stw r0, r7[0]
	}
...
.Lfunc_begin14:
	.loc	1 205 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:205:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel181:
...
.Ltmp444:
	...
	.loc	1 212 0 prologue_end    # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:212:0
.Ltmp445:
	{
		ldc r6, 0
		nop
...
.Lxtalabel183:
	...
	.loc	1 212 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:212:0
	st8 r0, r8[r6]
.LBB14_3:                               # %DFU_OpenFlash.exit
	...
	.loc	1 214 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:214:0
	{
		eq r0, r1, 2
		nop
	}
...
.Lxtalabel187:
	#DEBUG_VALUE: DFU_Upload:block_num <- 0
	#DEBUG_VALUE: firstRead <- 0
	.loc	1 229 10                # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:229:10
	bf r0, .LBB14_10
...
.Ltmp450:
	...
	.loc	1 232 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:232:0
	stw r0, dp[subPagesLeft]
	bu .LBB14_12
.LBB14_10:                              # %ifdone11
.Lxtalabel189:
...
.Ltmp451:
	#DEBUG_VALUE: firstRead <- 0
	.loc	1 235 5                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:235:5
	ldw r0, dp[subPagesLeft]
	bt r0, .LBB14_13
# BB#11:
	#DEBUG_VALUE: DFU_Upload:block_num <- 0
...
.Lxtalabel190:
	#DEBUG_VALUE: DFU_Upload:block_num <- 0
	#DEBUG_VALUE: firstRead <- 0
	.loc	1 237 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:237:0
	{
		ldaw r0, sp[2]
		stw r0, sp[2]
	}
	ldc r1, 64
	.loc	1 240 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:240:0
.Lxta.call_labels37:
	...
	.loc	1 241 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:241:0
	stw r0, dp[subPagesLeft]
	{
		nop
		ldw r0, sp[2]
	}
	.loc	1 244 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:244:9
	{
		eq r0, r0, 1
		nop
	}
...
.Lxtalabel191:
	...
	.loc	1 246 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:246:0
...
.Lxtalabel192:
	...
	#DEBUG_VALUE: firstRead <- 0
	ldc r6, 64
	.loc	1 254 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:254:0
	{
		mov r0, r5
		mov r1, r6
	}
.Lxta.call_labels38:
	...
	.loc	1 256 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:256:0
	ldw r0, dp[subPagesLeft]
	.loc	1 256 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:256:0
	{
		sub r0, r0, 1
...
.LBB14_15:                              # %return
	#DEBUG_VALUE: DFU_Upload:block_num <- 0
	.loc	1 248 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:248:0
	{
		mov r0, r6
		stw r0, r4[0]
	}
...
.Lfunc_begin15:
	.loc	1 335 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:335:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel193:
...
.Ltmp457:
	...
	ldw r0, cp[.LCPI15_0]
.Ltmp458:
	.loc	1 32 0 prologue_end     # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:32:0
	#APP
	ldw r0, r0[0]
	#NO_APP
.Ltmp459:
	...
	ldw r1, cp[.LCPI15_1]
.Ltmp460:
	.loc	1 343 5                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:343:5
	{
		eq r0, r0, r1
		nop
	}
...
.Ltmp463:
	.loc	1 347 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:347:0
...
.Lxtalabel195:
	...
	#DEBUG_VALUE: inDFU <- 0
	#DEBUG_VALUE: currentTime <- 0
	.loc	1 351 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:351:0
...
.Ltmp468:
	#DEBUG_VALUE: DFUReportResetState:c_user_cmd <- R0
	.loc	1 388 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:388:0
	{
		ldc r0, 0
		nop
	}
.Ltmp469:
	.loc	1 360 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:360:0
	stw r0, dp[g_DFU_state]
	.loc	1 388 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:388:0
...
.Ltmp470:
	#DEBUG_VALUE: DFUReportResetState:c_user_cmd <- R0
	.loc	1 80 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:80:0
.Lxta.call_labels39:
	bl DFUCustomFlashDisable
.Ltmp471:
	.loc	1 81 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:81:0
.Lxta.call_labels40:
	bl flash_cmd_deinit
.Ltmp472:
	.loc	1 388 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:388:0
...
.Lxtalabel200:
	...
	.loc	1 355 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:355:0
	stw r1, dp[g_DFU_state]
	.loc	1 357 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:357:0
	{
		gettime r1
		nop
	}
.Ltmp475:
	...
	.loc	1 358 13                # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:358:13
...
.Lxtalabel201:
	...
	#DEBUG_VALUE: inDFU <- 0
	#DEBUG_VALUE: currentTime <- 0
	.loc	1 381 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:381:0
	stw r1, dp[g_DFU_state]
.Ltmp478:
	#DEBUG_VALUE: inDFU <- 1
	{
...
.Lfunc_begin16:
	.loc	1 427 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:427:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel202:
...
.Ltmp490:
	...
	.loc	1 403 0 prologue_end    # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:403:0
	{
		get r11, id
		stw r1, sp[11]
	}
...
.Ltmp491:
	...
	.loc	1 430 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:430:9
	{
		clre
		ldw r8, r1[0]
	}
...
.Ltmp500:
	...
	.loc	1 436 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:436:0
	stw r7, sp[77]
	#DEBUG_VALUE: dfu_reset_override <- 0
	.loc	1 438 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:438:0
.Ltmp501:
...
.Ltmp545:
	#DEBUG_VALUE: return_data_len <- 0
	.loc	1 472 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:472:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp546:
...
.Lxtalabel229:
	...
	.loc	1 329 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:329:0
.Ltmp564:
	stw r0, sp[76]
.Ltmp565:
	#DEBUG_VALUE: return_data_len <- 0
	.loc	1 483 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:483:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp566:
...
.Ltmp580:
	#DEBUG_VALUE: s <- R0
	#DEBUG_VALUE: return_data_len <- 0
	.loc	1 493 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:493:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp581:
...
.Lxtalabel234:
	...
	#DEBUG_VALUE: return_data_len <- 0
	#DEBUG_VALUE: dfu_reset_override <- 0
	.loc	1 505 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:505:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp588:
...
.Lxtalabel235:
	...
	.loc	1 509 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:509:0
.Ltmp592:
	{
		out res[r8], r0
		nop
...
.Lxtalabel236:
	...
	#DEBUG_VALUE: DFUHandler:c_user_cmd <- R1
	#DEBUG_VALUE: return_data_len <- 0
	.loc	1 514 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:514:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp597:
...
.Lxtalabel237:
	...
	#DEBUG_VALUE: DFUHandler:c_user_cmd <- R1
	#DEBUG_VALUE: return_data_len <- 0
	.loc	1 519 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:519:0
	stw r7, sp[77]
	.loc	1 525 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:525:0
	ldw r0, sp[76]
.Ltmp601:
...
.LBB16_20:                              # %DFU_GetStatus.exit
                                        #   in Loop: Header=BB16_1 Depth=1
.Lxtalabel244:
	.loc	1 273 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:273:0
	stw r0, sp[76]
.Ltmp621:
	.loc	1 466 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:466:0
	{
...
.Lxtalabel290:
	.loc	1 280 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:280:0
	stw r3, sp[66]
.Ltmp732:
	.loc	1 466 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:466:0
	{
...
.Lfunc_begin33:
	.loc	1 535 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:535:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel429:
...
.Ltmp1037:
	#DEBUG_VALUE: returnVal <- 0
	#DEBUG_VALUE: reset_device_after_ack <- 0
	.loc	1 537 0 prologue_end    # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:537:0
	{
		ldc r9, 2
		stw r3, sp[21]
	}
...
.Lxtalabel430:
	...
	#DEBUG_VALUE: reset_device_after_ack <- 0
	#DEBUG_VALUE: returnVal <- 0
	.loc	1 547 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:547:9
	{
		add r0, r6, 8
		ldc r3, 0
	}
...
.Ltmp1041:
	ldc r3, 68
.Ltmp1042:
	.loc	1 548 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:548:0
	{
		mov r0, r4
		nop
	}
...
.Lxtalabel432:
	...
	.loc	1 552 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:552:0
...
.Ltmp1045:
	...
	ldw r3, cp[.LCPI33_0]
	.loc	1 25 0                  # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:25:0
.Ltmp1046:
	#APP
	stw r2, r3[0]
	#NO_APP
.Ltmp1047:
	.loc	1 557 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:557:0
	stw r1, dp[g_DFU_state]
	bt r0, .LBB33_7
.Ltmp1048:
# BB#3:                                 # %iftrue9
.Lxtalabel433:
	...
	.loc	1 562 9                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:562:9
	{
		eq r0, r0, 1
		nop
	}
...
.Lxtalabel434:
	...
	.loc	1 564 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:564:0
	{
		ldaw r2, sp[4]
		stw r11, sp[1]
	}
...
.Lxtalabel435:
	...
	.loc	1 568 0                 # F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:568:0
.Lxta.call_labels79:
...
.Linfo_string1:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxta.call_labels60
	.ascii	"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc"
	.byte	0
	.long	62
...
.Ltrap_info_str0:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:453:39: error: out of bounds array access\n                            data[i] = data_buffer[i];\n                                      ^~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_0
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str1:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:461:29: error: out of bounds array access\n                            data_buffer[i] = data_out[i];\n                            ^~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_1
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str2:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:479:29: error: out of bounds array access\n                            data_buffer[i] = data_out[i];\n                            ^~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_2
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str3:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:468:29: error: out of bounds array access\n                            data_buffer[i] = data_out[i];\n                            ^~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_15
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str16:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_dfu/src/dfu.xc:453:39: error: out of bounds array or pointer access\n                            data[i] = data_buffer[i];\n                                      ^~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
