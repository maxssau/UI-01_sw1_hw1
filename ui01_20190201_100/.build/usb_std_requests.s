	.text
	.file	"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc"
...
.Lfunc_begin0:
	.file	1 "F:/Projects/UI-01_sw1_hw1/module_usb_shared/src\\usb_std_requests.xc"
	.loc	1 45 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:45:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp8:
	...
	.loc	1 46 0 prologue_end     # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:46:0
.Ltmp9:
	ldaw r11, cp[.str36]
	{
		ldc r1, 12
...
.Lxta.call_labels0:
	bl printstr
	.loc	1 47 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:47:0
	ldaw r11, cp[.str37]
	{
		ldc r7, 26
		mov r0, r11
...
.Lxta.call_labels1:
	bl printstr
	.loc	1 48 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:48:0
	{
		zext r10, 8
		nop
	}
...
.Lxta.call_labels2:
	bl printhexln
	.loc	1 49 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:49:0
	ldaw r11, cp[.str38]
	{
		ldc r1, 21
		mov r0, r11
...
.Lxta.call_labels3:
	bl printstr
	.loc	1 50 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:50:0
	{
		mov r0, r9
		nop
	}
.Lxta.call_labels4:
	bl printhexln
	.loc	1 51 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:51:0
	ldaw r11, cp[.str39]
	{
		mov r0, r11
		mov r1, r7
...
.Lxta.call_labels5:
	bl printstr
	.loc	1 52 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:52:0
	{
		zext r8, 8
		nop
	}
...
.Lxta.call_labels6:
	bl printhexln
	.loc	1 53 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:53:0
	ldaw r11, cp[.str40]
	{
		ldc r1, 11
		mov r0, r11
...
.Lxta.call_labels7:
	...
	.loc	1 54 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:54:0
.Lxta.call_labels8:
	bl printhexln
	.loc	1 55 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:55:0
	ldaw r11, cp[.str41]
	{
		ldc r7, 23
		mov r0, r11
...
.Lxta.call_labels9:
	bl printstr
	.loc	1 56 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:56:0
	{
		zext r6, 16
		nop
	}
...
.Lxta.call_labels10:
	bl printhexln
	.loc	1 57 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:57:0
	ldaw r11, cp[.str42]
	{
		mov r0, r11
		mov r1, r7
...
.Lxta.call_labels11:
	bl printstr
	.loc	1 58 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:58:0
	{
		zext r5, 16
		nop
	}
...
.Lxta.call_labels12:
	bl printhexln
	.loc	1 59 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:59:0
	ldaw r11, cp[.str43]
	{
		ldc r1, 24
		mov r0, r11
...
.Lxta.call_labels13:
	bl printstr
	.loc	1 60 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:60:0
	{
		zext r4, 16
		nop
	}
...
.Lfunc_begin1:
	.loc	1 27 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:27:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel1:
...
.Ltrap_info0:
	...
	.loc	1 28 0 prologue_end     # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:28:0
.Ltmp20:
	{
		shl r10, r7, 5
		ld8u r4, r0[r9]
	...
	.loc	1 28 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:28:0
	{
		shl r0, r0, 7
		nop
	}
	...
	.loc	1 28 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:28:0
	st8 r0, r1[r9]
	.loc	1 32 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:32:0
	{
		lsu r0, r8, r2
		nop
	}
.Ltrap_info1:
	...
	.loc	1 32 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:32:0
	st8 r6, r1[r8]
	.loc	1 34 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:34:0
	{
		lsu r0, r7, r2
		nop
	}
.Ltrap_info2:
	...
	.loc	1 35 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:35:0
	{
		lsu r0, r4, r2
		nop
	}
.Ltrap_info3:
	...
	.loc	1 37 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:37:0
	{
		lsu r4, r0, r2
		nop
	}
.Ltrap_info4:
	...
	.loc	1 38 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:38:0
	{
		lsu r4, r0, r2
		nop
	}
.Ltrap_info5:
	...
	.loc	1 40 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:40:0
	{
		lsu r11, r0, r2
		nop
	}
.Ltrap_info6:
	...
	.loc	1 41 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:41:0
	{
		lsu r2, r0, r2
		nop
	}
...
.Lfunc_begin2:
	.loc	1 7 0                   # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:7:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel2:
...
.Ltrap_info8:
	...
	#DEBUG_VALUE: USB_ParseSetupPacket:b <- R0
	#DEBUG_VALUE: USB_ParseSetupPacket:p <- R1
	.loc	1 9 0 prologue_end      # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:9:0
.Ltmp26:
	{
		ldc r3, 0
		nop
	...
	.loc	1 9 0                   # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:9:0
	{
		mov r4, r11
		nop
	}
	...
	.loc	1 9 0                   # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:9:0
	st8 r4, r1[r3]
	.loc	1 10 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:10:0
	{
		shr r5, r11, 5
		nop
	}
	...
	.loc	1 10 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:10:0
	st8 r5, r1[r4]
	.loc	1 11 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:11:0
	{
		shr r5, r11, 7
		ldc r11, 2
	}
	.loc	1 11 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:11:0
	st8 r5, r1[r11]
	.loc	1 14 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:14:0
	{
		lsu r5, r4, r2
		nop
	}
.Ltrap_info9:
	...
	.loc	1 14 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:14:0
	st8 r5, r1[r4]
	.loc	1 17 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:17:0
	{
		lsu r5, r4, r2
		nop
	}
.Ltrap_info10:
	...
	.loc	1 20 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:20:0
	{
		lsu r4, r11, r2
		nop
	}
.Ltrap_info11:
	...
	.loc	1 23 0                  # F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:23:0
	{
		lsu r2, r11, r2
		nop
	}
...
.Linfo_string1:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxta.call_labels0
	.ascii	"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc"
	.byte	0
	.long	46
...
.Ltrap_info_str0:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:28:5: error: out of bounds array access\n    buffer[0] = sp.bmRequestType.Recipient\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_0
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str1:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:32:5: error: out of bounds array access\n    buffer[1] = sp.bRequest;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_1
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str2:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:34:5: error: out of bounds array access\n    buffer[2] = sp.wValue & 0xff;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_2
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str3:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:35:5: error: out of bounds array access\n    buffer[3] = (sp.wValue & 0xff00)>>8;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_3
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str4:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:37:5: error: out of bounds array access\n    buffer[4] = sp.wIndex & 0xff;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_4
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str5:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:38:5: error: out of bounds array access\n    buffer[5] = (sp.wIndex & 0xff00)>>8;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_5
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str6:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:40:5: error: out of bounds array access\n    buffer[6] = sp.wLength & 0xff;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_6
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str7:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:41:5: error: out of bounds array access\n    buffer[7] = (sp.wLength & 0xff00)>>8;\n    ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_7
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str8:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:9:33: error: out of bounds array access\n    p.bmRequestType.Recipient = b[0] & 0x1f;\n                                ^~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_8
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str9:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:14:18: error: out of bounds array access\n    p.bRequest = b[1];\n                 ^~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_9
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str10:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:17:17: error: out of bounds array access\n    p.wValue = (b[3] << 8) | (b[2]);\n                ^~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_10
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str11:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:20:17: error: out of bounds array access\n    p.wIndex = (b[5] << 8) | (b[4]);\n                ^~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_11
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str12:
.asciiz"F:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usb_std_requests.xc:23:18: error: out of bounds array access\n    p.wLength = (b[7] << 8) | (b[6]);\n                 ^~~~\n"
	.section	.trap_info,"",@progbits
