# 1 "F:/Projects/UI-01_sw1_hw1/module_xud/src/XUD_Ports.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "F:/Projects/UI-01_sw1_hw1/module_xud/src/XUD_Ports.xc" 2
...
# 2 "F:/Projects/UI-01_sw1_hw1/module_xud/src/XUD_Ports.xc" 2

in port flag0_port = on tile[0]: 0x10600;
in port flag1_port = on tile[0]: 0x10400;
in port flag2_port = on tile[0]: 0x10500;


  in buffered port:32 p_usb_clk = on tile[0]: 0x10800;
  out buffered port:32 p_usb_txd = on tile[0]: 0x80000;
  in buffered port:32 p_usb_rxd = on tile[0]: 0x80100;
  out port tx_readyout = on tile[0]: 0x10900;
  in port tx_readyin = on tile[0]: 0x10700;
  in port rx_rdy = on tile[0]: 0x10a00;

  on tile[0]: __clock_t tx_usb_clk = 0x506;
  on tile[0]: __clock_t rx_usb_clk = 0x406;
