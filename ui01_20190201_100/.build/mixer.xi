# 1 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 4 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 5 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 6 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 7 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 8 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 9 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 10 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc" 2
...
# 39 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 69 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 113 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 162 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 198 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 243 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
 ...
 for (int i=0; i<(2); i++)
        {
            ...
            int index;
# 274 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
            unsafe
            {

                sample = ptr_samples[i];
            }
# 294 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
            __builtin_out_uint(c, sample);
 ...
 for (int i=0;i<(2);i++)
    {
        ...
        int old_x;
        sample = __builtin_in_uint(c);
# 340 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
        unsafe
        {
 ...
 request = __builtin_in_uint(c_mixer2);
        ...
        select
        {
            case __builtin_in_uint_byref(c_mix_ctl, cmd):
            {
                ...
                switch (cmd)
                {
# 438 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
                    ...
                    case GET_INPUT_LEVELS:
                        index = __builtin_in_uint(c_mix_ctl);
                        __builtin_chkct(c_mix_ctl, 0x1);
# 462 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
                        ...
                        __builtin_outct(c_mix_ctl, 0x1);
                        break;
# 482 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
                }
                break;
            }
            default:
...
#pragma loop unroll
 ...
 for (int i=0;i<0;i++)
        ...
        {
# 609 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 752 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 777 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
...
# 806 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
    for (int i=0;i<(2);i++)
    {
      asm volatile("stw %0, %1[%2]"::"r"((2) + i),"r"(samples_to_host_map),"r"(i));
    }
# 823 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/mixer/mixer.xc"
    par
    {
