# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 9 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 1 3
# 39 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safestrcpy(char s1[], const char s2[]);
# 50 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safestrncpy(char s1[], const char s2[], unsigned n);
# 59 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safestrcat(char s1[], const char s2[]);
# 71 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safestrncat(char s1[], const char s2[], unsigned n);
# 84 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safestrcmp(const char s1[], const char s2[]);
# 98 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
...
# 118 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safestrchr(const char s[], int c);
# 130 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safestrrchr(const char s[], int c);
# 140 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
unsigned safestrspn(const char s1[], const char s2[]);
# 150 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
unsigned safestrcspn(const char s1[], const char s2[]);
# 159 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safestrpbrk(const char s1[], const char s2[]);
# 170 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safestrstr(const char s1[], const char s2[]);
# 185 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safememcpy(unsigned char *dst, const unsigned char *src, unsigned length);
# 198 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safememmove(unsigned char data[], unsigned dst, unsigned src,
                 unsigned length);
# 214 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
void safememset(unsigned char *dst, int value, unsigned length);
# 232 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safememcmp(const unsigned char s1[], const unsigned char s2[],
               unsigned length);
# 247 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\safestring.h" 3
int safememchr(const unsigned char s[], int c, unsigned length);
# 10 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 11 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 137 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\print.h" 3
int printstr(const char *s);
# 147 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\print.h" 3
...
# 13 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 14 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 57 "C:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usbaudiocommon.h"
typedef struct
{
    unsigned char bLength;
    unsigned char bDescriptorType;
...
# 88 "C:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usbaudiocommon.h"
typedef struct
{
    unsigned char bLength;
    unsigned char bDescriptorType;
...
# 140 "C:/Projects/UI-01_sw1_hw1/module_usb_shared/src/usbaudiocommon.h"
typedef struct
{
    unsigned char bLength;
    unsigned char bDescriptorType;
...
# 161 "C:/Projects/UI-01_sw1_hw1/module_usb_shared/src\\usbaudio20.h"
typedef struct
{
    unsigned char bLength;
    unsigned char bDescriptorType;
...
# 15 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2

# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio\\devicedefines.h" 1
# 17 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src\\usb_device.h" 1
# 55 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src\\usb_device.h"
...
# 18 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 1
# 10 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/clang\\stddef.h" 1 3
# 11 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio\\devicedefines.h" 1
# 12 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptor_defs.h" 1
# 33 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptor_defs.h"
...
# 58 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptor_defs.h"
    INTERFACE_COUNT
};
# 13 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 2


# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_shared/src\\usb_std_descriptors.h" 1
...
# 16 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 2
# 32 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
typedef struct
{
    char *langID;
    char *vendorStr;
...
# 170 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    char *inputChanStr_1;


    char *inputChanStr_2;
# 294 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h" 1
    ...
    .outputChanStr_1 = ""
        ...
        "Analogue 1"
# 45 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h"
        ,
    ...
    .outputChanStr_2 = ""
        ...
        "Analogue 2"
# 85 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h"
        ,
# 1292 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h"
    .inputChanStr_1 = ""

        "Analogue 1"
# 1328 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h"
        ,
    ...
    .inputChanStr_2 = ""
        ...
        "Analogue 2"
# 1368 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/chanstrings.h"
        ,
# 335 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h" 2
# 371 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 610 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
typedef struct
{
...
# 654 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 728 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    unsigned char configDesc_DFU[(18)];
# 752 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 889 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
        .Audio_ClockSelector =
        {
...
# 945 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
        .Audio_Out_FeatureUnit =
        {
...

            {
                ...
                0x0000000F,
# 1058 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
            },
            0,
        },
...
# 1121 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
        .Audio_In_FeatureUnit =
        {
...

            {
                ...
                0x0000000F,
# 1233 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
            },
            0,
        },
...
# 1365 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    },
...
# 1464 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 1543 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 1625 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 1967 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    {0x09,
    0x04,
    INTERFACE_NUMBER_DFU,
    0x00,
...
# 1988 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x21,
    0x07,
    0xFA,
    ...
    0x10,
    0x01},
# 2145 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
};
# 2165 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
...
# 2216 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
const unsigned num_freqs_a1 = (((3)>((0 +1 +1)))?(3):((0 +1 +1)));
# 2266 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
unsigned char cfgDesc_Audio1[] =
{
    ...
    0x03,
# 2358 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x00,
    ...
    0x03,
# 2429 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x00,
    ...
    num_freqs_a1,
# 2486 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    (48000 & 0xff),((48000 & 0xff00)>> 8),((48000 & 0xff0000)>> 16),
# 2514 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x44, 0xAC, 0x00,



    0x80, 0xBB, 0x00,
# 2530 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x05,
    0x01,
    0x05,
    ...
    0x02,
    0x00, 0x00,
# 2567 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x04,
    ((1) + 1),
    0x00,
    ...
    24,
    num_freqs_a1,
# 2614 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    (48000 & 0xff),((48000 & 0xff00)>> 8),((48000 & 0xff0000)>> 16),
# 2642 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x44, 0xAC, 0x00,



    0x80, 0xBB, 0x00,
# 2658 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/descriptors.h"
    0x09,
    0x05,
    (ENDPOINT_NUMBER_IN_AUDIO | 0x80),
...
# 19 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 20 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 21 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/hostactive\\hostactive.h" 1

void UserHostActive(int active);
# 22 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/vendorrequests.h" 1
# 14 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/vendorrequests.h"
int VendorAudioRequests(XUD_ep ep0_out, XUD_ep ep0_in, unsigned char bRequest, unsigned char cs, unsigned char cn,
    ...
    chanend c_mix_ctl,
    chanend c_clk_ctL);
# 23 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_dfu/src\\dfu_types.h" 1
# 24 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 25 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/audiorequests.h" 1
...
# 26 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
# 58 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
# 1 "C:/Projects/UI-01_sw1_hw1/module_dfu/src\\dfu.h" 1
# 33 "C:/Projects/UI-01_sw1_hw1/module_dfu/src\\dfu.h"
...
# 59 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c" 2
...
# 273 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
    for(int j = 0; j < 0; j++)
    for(int i = 0; i < (18); i++)
    {
        mixSel[j][i] = i;
    }
# 286 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
                    ...
                    if(sp.bRequest == 0x0B)
                    {
                        switch (sp.wIndex)
                        {
                            ...
                            case INTERFACE_NUMBER_AUDIO_INPUT:
                                ...
                                break;
# 404 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
                            default:
...
# 458 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
                    }
                ...
                case ((1 << 7) | (0x00 << 5) | (0x01)):
                    ...
                    switch(sp.bRequest)
                    {
# 491 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
                        default:
                            break;
                   }
                   break;
...
# 621 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
                        }
                    }
                    break;
        ...
        if(result == XUD_RES_ERR)
        {
            ...
            if (!DFU_mode_active)
            {
                ...
                result = USB_StandardRequests(ep0_out, ep0_in,
                    ...
                    &sp, g_curUsbSpeed);
# 745 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/endpoint0/endpoint0.c"
            }
            else
            {
