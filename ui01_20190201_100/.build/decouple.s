	.text
	.file	"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc"
	...
	.set usage.anon.9,0
	.set usage.anon.10,0
	.globread decouple,buffer_aud_ctl_chan,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:730:54: note: object used here\n                asm volatile(\"outct res[%0],%1\"::\"r\"(buffer_aud_ctl_chan),\"r\"(XS1_CT_END));\n                                                     ^~~~~~~~~~~~~~~~~~~"
	.globread decouple,aud_to_host_usb_ep,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:711:38: note: object used here\n                SetupZerosSendBuffer(aud_to_host_usb_ep, sampFreq, g_curSubSlot_In);\n                                     ^~~~~~~~~~~~~~~~~~"
	.globread decouple,aud_from_host_usb_ep,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:654:25: note: object used here\n    XUD_SetReady_OutPtr(aud_from_host_usb_ep, g_aud_from_host_wrptr+4);\n                        ^~~~~~~~~~~~~~~~~~~~"
	.globread decouple,inZeroBuff,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:621:25: note: object used here\n    t = array_to_xc_ptr(inZeroBuff);\n                        ^~~~~~~~~~"
	.globread decouple,audioBuffIn,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:609:25: note: object used here\n    t = array_to_xc_ptr(audioBuffIn);\n                        ^~~~~~~~~~~"
	.globread decouple,outAudioBuff,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:595:29: note: object used here\n    int t = array_to_xc_ptr(outAudioBuff);\n                            ^~~~~~~~~~~~"
	.globread decouple,multIn,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:601:32: note: object used here\n    p_multIn = array_to_xc_ptr(multIn);\n                               ^~~~~~"
	.globread decouple,multOut,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:598:33: note: object used here\n    p_multOut = array_to_xc_ptr(multOut);\n                                ^~~~~~~"
	.globread usage.anon.10,g_aud_to_host_zeros,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:563:48: note: object used here\n    asm volatile(\"stw %0, %1[0]\"::\"r\"(mid),\"r\"(g_aud_to_host_zeros));\n                                               ^~~~~~~~~~~~~~~~~~~"
	.globread usage.anon.10,g_numUsbChan_In,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:561:12: note: object used here\n    mid *= g_numUsbChan_In * slotSize;\n           ^~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_curSubSlot_In,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:296:16: note: object used here\n        switch(g_curSubSlot_In)\n               ^~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_curSubSlot_Out,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:161:16: note: object used here\n        switch(g_curSubSlot_Out)\n               ^~~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_aud_to_host_rdptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:470:26: note: object used here\n            space_left = g_aud_to_host_rdptr - g_aud_to_host_wrptr;\n                         ^~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,aud_to_host_fifo_end,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:444:40: note: object used here\n            if (g_aud_to_host_wrptr >= aud_to_host_fifo_end)\n                                       ^~~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,aud_to_host_fifo_start,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:446:39: note: object used here\n                g_aud_to_host_wrptr = aud_to_host_fifo_start;\n                                      ^~~~~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_aud_from_host_wrptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:146:20: note: object used here\n        outSamps = g_aud_from_host_wrptr - g_aud_from_host_rdptr;\n                   ^~~~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,aud_from_host_fifo_end,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:531:38: note: object used here\n        if (g_aud_from_host_rdptr >= aud_from_host_fifo_end)\n                                     ^~~~~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,aud_from_host_fifo_start,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:533:37: note: object used here\n            g_aud_from_host_rdptr = aud_from_host_fifo_start;\n                                    ^~~~~~~~~~~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_numUsbChan_In,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:302:45: note: object used here\n                for(unsigned int i = 0; i < g_numUsbChan_In; i++)\n                                            ^~~~~~~~~~~~~~~"
	.globread handle_audio_request,g_numUsbChan_Out,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:169:45: note: object used here\n                for(unsigned int i = 0; i < g_numUsbChan_Out; i++)\n                                            ^~~~~~~~~~~~~~~~"
	.globread handle_audio_request,usage.anon.9,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:312:66: note: object used here\n                    asm volatile(\"ldw %0, %1[%2]\":\"=r\"(mult):\"r\"(p_multIn),\"r\"(i));\n                                                                 ^~~~~~~~"
	.globread handle_audio_request,usage.anon.8,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:182:66: note: object used here\n                    asm volatile(\"ldw %0, %1[%2]\":\"=r\"(mult):\"r\"(p_multOut),\"r\"(i));\n                                                                 ^~~~~~~~~"
	.globwrite decouple,g_maxPacketSize,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:764:21: note: object used here\n                    g_maxPacketSize = (MAX_DEVICE_AUD_PACKET_SIZE_MULT_HS * g_numUsbChan_In);\n                    ^~~~~~~~~~~~~~~"
	.globwrite decouple,g_curSubSlot_In,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:746:35: note: object used here\n                GET_SHARED_GLOBAL(g_curSubSlot_In, g_formatChange_SubSlot);\n                                  ^~~~~~~~~~~~~~~\nC:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\xc_ptr.h:36:72: note: expanded from macro \'GET_SHARED_GLOBAL\'\n#define GET_SHARED_GLOBAL(x, g) asm volatile(\"ldw %0, dp[\" #g \"]\":\"=r\"(x)::\"memory\")\n                                                                       ^"
	.globwrite decouple,g_curSubSlot_Out,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:785:35: note: object used here\n                GET_SHARED_GLOBAL(g_curSubSlot_Out, g_formatChange_SubSlot);\n                                  ^~~~~~~~~~~~~~~~\nC:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\xc_ptr.h:36:72: note: expanded from macro \'GET_SHARED_GLOBAL\'\n#define GET_SHARED_GLOBAL(x, g) asm volatile(\"ldw %0, dp[\" #g \"]\":\"=r\"(x)::\"memory\")\n                                                                       ^"
	.globwrite decouple,unpackState,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:793:17: note: object used here\n                unpackState = 0;\n                ^~~~~~~~~~~"
	.globwrite decouple,inUnderflow,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:702:17: note: object used here\n                inUnderflow = 1;\n                ^~~~~~~~~~~"
	.globwrite decouple,outOverflow,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:723:21: note: object used here\n                    outOverflow = 0;\n                    ^~~~~~~~~~~"
	.globwrite decouple,outUnderflow,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:714:17: note: object used here\n                outUnderflow = 1;\n                ^~~~~~~~~~~~"
	.globwrite decouple,g_aud_to_host_zeros,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:622:5: note: object used here\n    g_aud_to_host_zeros = t;\n    ^~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,g_aud_to_host_rdptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:614:5: note: object used here\n    g_aud_to_host_rdptr = aud_to_host_fifo_start;\n    ^~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,g_aud_to_host_dptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:615:5: note: object used here\n    g_aud_to_host_dptr = aud_to_host_fifo_start + 4;\n    ^~~~~~~~~~~~~~~~~~"
	.globwrite decouple,g_aud_to_host_wrptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:613:5: note: object used here\n    g_aud_to_host_wrptr = aud_to_host_fifo_start;\n    ^~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,aud_to_host_fifo_end,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:612:5: note: object used here\n    aud_to_host_fifo_end = aud_to_host_fifo_start + BUFF_SIZE_IN*4;\n    ^~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,aud_to_host_fifo_start,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:611:5: note: object used here\n    aud_to_host_fifo_start = t;\n    ^~~~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,g_aud_from_host_rdptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:607:5: note: object used here\n    g_aud_from_host_rdptr = aud_from_host_fifo_start;\n    ^~~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,g_aud_from_host_wrptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:606:5: note: object used here\n    g_aud_from_host_wrptr = aud_from_host_fifo_start;\n    ^~~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,aud_from_host_fifo_end,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:605:5: note: object used here\n    aud_from_host_fifo_end = aud_from_host_fifo_start + BUFF_SIZE_OUT*4;\n    ^~~~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,aud_from_host_fifo_start,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:604:5: note: object used here\n    aud_from_host_fifo_start = t;\n    ^~~~~~~~~~~~~~~~~~~~~~~~"
	.globwrite decouple,speedRem,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:734:17: note: object used here\n                speedRem = 0;\n                ^~~~~~~~"
	.globwrite decouple,g_numUsbChan_In,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:745:35: note: object used here\n                GET_SHARED_GLOBAL(g_numUsbChan_In, g_formatChange_NumChans);\n                                  ^~~~~~~~~~~~~~~\nC:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\xc_ptr.h:36:72: note: expanded from macro \'GET_SHARED_GLOBAL\'\n#define GET_SHARED_GLOBAL(x, g) asm volatile(\"ldw %0, dp[\" #g \"]\":\"=r\"(x)::\"memory\")\n                                                                       ^"
	.globwrite decouple,g_numUsbChan_Out,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:784:35: note: object used here\n                GET_SHARED_GLOBAL(g_numUsbChan_Out, g_formatChange_NumChans);\n                                  ^~~~~~~~~~~~~~~~\nC:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\xc_ptr.h:36:72: note: expanded from macro \'GET_SHARED_GLOBAL\'\n#define GET_SHARED_GLOBAL(x, g) asm volatile(\"ldw %0, dp[\" #g \"]\":\"=r\"(x)::\"memory\")\n                                                                       ^"
	.globwrite decouple,usage.anon.9,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:601:5: note: object used here\n    p_multIn = array_to_xc_ptr(multIn);\n    ^~~~~~~~"
	.globwrite decouple,usage.anon.8,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:598:5: note: object used here\n    p_multOut = array_to_xc_ptr(multOut);\n    ^~~~~~~~~"
	.globwrite handle_audio_request,packData,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:385:29: note: object used here\n                            packData = sample;\n                            ^~~~~~~~"
	.globwrite handle_audio_request,packState,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:406:21: note: object used here\n                    packState++;\n                    ^~~~~~~~~"
	.globwrite handle_audio_request,unpackData,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:242:45: note: object used here\n                            read_via_xc_ptr(unpackData, g_aud_from_host_rdptr);\n                                            ^~~~~~~~~~\nC:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\xc_ptr.h:31:74: note: expanded from macro \'read_via_xc_ptr\'\n#define read_via_xc_ptr(x,p)                    asm(\"ldw %0, %1[0]\":\"=r\"(x):\"r\"(p));\n                                                                         ^"
	.globwrite handle_audio_request,unpackState,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:262:21: note: object used here\n                    unpackState++;\n                    ^~~~~~~~~~~"
	.globwrite handle_audio_request,outUnderflow,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:155:13: note: object used here\n            outUnderflow = 0;\n            ^~~~~~~~~~~~"
	.globwrite handle_audio_request,aud_data_remaining_to_device,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:289:9: note: object used here\n        aud_data_remaining_to_device -= (g_numUsbChan_Out * g_curSubSlot_Out);\n        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globwrite handle_audio_request,totalSampsToWrite,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:459:13: note: object used here\n            totalSampsToWrite = speedRem >> 16;\n            ^~~~~~~~~~~~~~~~~"
	.globwrite handle_audio_request,sampsToWrite,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:421:9: note: object used here\n        sampsToWrite--;\n        ^~~~~~~~~~~~"
	.globwrite handle_audio_request,g_aud_to_host_dptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:322:21: note: object used here\n                    g_aud_to_host_dptr+=2;\n                    ^~~~~~~~~~~~~~~~~~"
	.globwrite handle_audio_request,g_aud_to_host_wrptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:441:13: note: object used here\n            g_aud_to_host_wrptr += 4+datasize;\n            ^~~~~~~~~~~~~~~~~~~"
	.globwrite handle_audio_request,g_aud_from_host_rdptr,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:178:21: note: object used here\n                    g_aud_from_host_rdptr+=2;\n                    ^~~~~~~~~~~~~~~~~~~~~"
	.globwrite handle_audio_request,speedRem,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:458:13: note: object used here\n            speedRem += speed;\n            ^~~~~~~~"
	...
	.globpassesref usage.anon.3, inZeroBuff,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:621:9: error: call to `array_to_xc_ptr\' in `decouple\' makes alias of global \'inZeroBuff\'\n    t = array_to_xc_ptr(inZeroBuff);\n        ^~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref usage.anon.3, audioBuffIn,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:609:9: error: call to `array_to_xc_ptr\' in `decouple\' makes alias of global \'audioBuffIn\'\n    t = array_to_xc_ptr(audioBuffIn);\n        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref usage.anon.3, multIn,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:601:16: error: call to `array_to_xc_ptr\' in `decouple\' makes alias of global \'multIn\'\n    p_multIn = array_to_xc_ptr(multIn);\n               ^~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref usage.anon.3, multOut,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:598:17: error: call to `array_to_xc_ptr\' in `decouple\' makes alias of global \'multOut\'\n    p_multOut = array_to_xc_ptr(multOut);\n                ^~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref usage.anon.3, outAudioBuff,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:595:13: error: call to `array_to_xc_ptr\' in `decouple\' makes alias of global \'outAudioBuff\'\n    int t = array_to_xc_ptr(outAudioBuff);\n            ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
.Ldebug_range:
	.file	1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\decouple.xc"
...
.Lfunc_begin0:
	.loc	1 126 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:126:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp10:
	.loc	1 136 5 prologue_end    # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:136:5
	ldw r9, dp[outUnderflow]
	.loc	1 136 5                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:136:5
	bf r9, .LBB0_7
.Ltmp11:
...
.Lxtalabel1:
	...
	#DEBUG_VALUE: underflowSample <- R1
	#DEBUG_VALUE: i <- 1
	.loc	1 142 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:142:0
...
.Ltmp12:
	.loc	1 146 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:146:0
...
.Ltmp14:
	...
	.loc	1 147 9                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:147:9
	ashr r1, r2, 32
	bf r1, .LBB0_3
.Ltmp15:
# BB#2:
	...
	#DEBUG_VALUE: outSamps <- R2
	ldc r1, 1632
	.loc	1 149 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:149:0
	{
		add r2, r2, r1
		nop
	}
...
.Lxtalabel2:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	ldc r1, 411
	.loc	1 153 9                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:153:9
	{
		lss r1, r1, r2
		nop
	}
...
.Lxtalabel3:
	...
	.loc	1 155 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:155:0
...
.Lxtalabel4:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 161 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:161:0
...
.Lxtalabel5:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 230 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:230:0
...
# BB#32:                                # %LoopBody102.preheader
	...
	.loc	1 265 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:265:0
.Ltmp21:
	ldw r11, dp[p_multOut]
	.loc	1 262 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:262:0
...
.Lxtalabel6:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 239 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:239:0
	{
		add r4, r3, r9
		nop
	}
...
.Lxtalabel8:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 242 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:242:0
	...
	.loc	1 243 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:243:0
	{
		add r4, r4, 4
		nop
	}
	...
	.loc	1 244 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:244:0
	{
		shl r10, r5, 8
		nop
	}
...
.Lxtalabel9:
	...
	.loc	1 247 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:247:0
	{
		zext r4, 16
		nop
	}
	.loc	1 248 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:248:0
	...
	.loc	1 249 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:249:0
	{
		add r5, r5, 4
		nop
	}
	...
	.loc	1 250 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:250:0
	{
		shl r5, r8, 16
		nop
	}
...
.Lxtalabel10:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 253 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:253:0
...
.Ltmp31:
	...
	.loc	1 254 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:254:0
	ldw r5, dp[g_aud_from_host_rdptr]
	.loc	1 254 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:254:0
	#APP
	ldw r8, r5[0]
	...
	.loc	1 254 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:254:0
	stw r8, dp[unpackData]
	.loc	1 255 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:255:0
	{
		add r5, r5, 4
		nop
	}
	.loc	1 255 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:255:0
	stw r5, dp[g_aud_from_host_rdptr]
	.loc	1 256 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:256:0
	{
		shl r5, r8, 24
		nop
	}
...
.Lxtalabel11:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 259 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:259:0
	ldw r4, dp[unpackData]
	ldw r5, cp[.LCPI0_0]
	.loc	1 259 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:259:0
	{
...
.Ltmp35:
	#DEBUG_VALUE: mult <- R4
	.loc	1 266 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:266:0
	{
		mov r8, r1
		mov r5, r1
	}
	...
	maccs r8, r5, r4, r10
	#NO_APP
	.loc	1 267 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:267:0
	{
		shl r4, r8, 3
		nop
	}
.Ltmp36:
	#DEBUG_VALUE: h <- R4
	#DEBUG_VALUE: i <- R9
	.loc	1 268 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:268:0
...
.Lxtalabel14:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 198 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:198:0
	ldw r2, dp[g_numUsbChan_Out]
	bf r2, .LBB0_10
.Ltmp43:
# BB#26:                                # %LoopBody67.preheader
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 210 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:210:0
	ldw r11, dp[p_multOut]
	.loc	1 207 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:207:0
	...
	.loc	1 206 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:206:0
	bt r4, .LBB0_27
.Ltmp44:
...
.Lxtalabel15:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 169 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:169:0
	ldw r2, dp[g_numUsbChan_Out]
	bf r2, .LBB0_10
.Ltmp46:
# BB#19:                                # %LoopBody39.preheader
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 182 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:182:0
	ldw r11, dp[p_multOut]
	.loc	1 178 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:178:0
	...
	.loc	1 177 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:177:0
	bt r4, .LBB0_20
.Ltmp47:
...
.Ltmp53:
	...
	.loc	1 211 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:211:0
	{
		mov r5, r3
		mov r4, r3
	}
...
.Ltmp54:
	#DEBUG_VALUE: h <- R5
	.loc	1 212 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:212:0
	{
		shl r5, r5, 3
		shr r4, r4, r6
	}
.Ltmp55:
	.loc	1 214 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:214:0
	{
		or r4, r5, r4
		nop
	}
.Ltmp56:
	#DEBUG_VALUE: h <- R4
	#DEBUG_VALUE: i <- R8
	.loc	1 217 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:217:0
...
.Ltmp67:
	#DEBUG_VALUE: mult <- R9
	.loc	1 183 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:183:0
	{
		mov r10, r4
		mov r5, r4
	}
	...
	maccs r10, r5, r9, r8
	#NO_APP
	.loc	1 185 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:185:0
	{
		shl r5, r10, 3
		nop
	}
.Ltmp68:
	#DEBUG_VALUE: h <- R5
	#DEBUG_VALUE: i <- R7
	.loc	1 186 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:186:0
...
.Lxtalabel19:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 283 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:283:0
	{
		eq r3, r2, 2
		nop
	}
...
.Lxtalabel20:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- R4
	.loc	1 285 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:285:0
...
.Lxtalabel21:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 289 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:289:0
	mul r1, r5, r2
	.loc	1 289 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:289:0
...
.Lxtalabel22:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 296 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:296:0
...
.Lxtalabel23:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 331 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:331:0
	ldw r11, dp[g_aud_to_host_dptr]
.Ltmp81:
	#DEBUG_VALUE: i <- 0
	#DEBUG_VALUE: ptr <- R11
	.loc	1 333 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:333:0
...
# BB#63:                                # %LoopBody229.preheader
	...
	#DEBUG_VALUE: ptr <- R11
	#DEBUG_VALUE: i <- 0
	.loc	1 343 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:343:0
	ldw r4, dp[p_multIn]
	{
		mkmsk r1, 1
		nop
...
.Ltmp83:
	.loc	1 336 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:336:0
	bt r1, .LBB0_64
.Ltmp84:
...
.Lxtalabel24:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 368 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:368:0
	ldw r3, dp[g_numUsbChan_In]
	.loc	1 368 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:368:0
	bf r3, .LBB0_71
.Ltmp86:
# BB#72:                                # %LoopBody260.preheader
	...
	.loc	1 377 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:377:0
.Ltmp87:
	ldw r4, dp[p_multIn]
	.loc	1 406 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:406:0
...
.Lxtalabel25:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- 0
	.loc	1 371 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:371:0
...
.Ltmp92:
	#DEBUG_VALUE: mult <- R1
	.loc	1 382 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:382:0
	{
		add r2, r11, r6
		nop
	}
...
.Lxtalabel26:
	...
	#DEBUG_VALUE: sample <- R8
	#DEBUG_VALUE: mult <- R1
	.loc	1 378 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:378:0
	{
		mov r9, r5
		mov r10, r5
	}
	...
	maccs r9, r10, r1, r8
	#NO_APP
	.loc	1 379 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:379:0
	{
		shl r8, r9, 3
		nop
	}
...
.Lxtalabel27:
	...
	#DEBUG_VALUE: i <- 0
	#DEBUG_VALUE: sample <- R8
	.loc	1 385 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:385:0
	stw r8, dp[packData]
	bu .LBB0_81
.Ltmp96:
...
.Lxtalabel28:
	...
	#DEBUG_VALUE: i <- 0
	#DEBUG_VALUE: sample <- R8
	.loc	1 388 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:388:0
	ldw r1, dp[packData]
	.loc	1 388 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:388:0
	{
		shr r1, r1, 8
	...
	.loc	1 389 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:389:0
	ldw r2, dp[g_aud_to_host_dptr]
	.loc	1 389 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:389:0
	#APP
	stw r1, r2[0]
	#NO_APP
	.loc	1 390 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:390:0
	{
		add r1, r2, 4
		nop
	}
	...
	.loc	1 391 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:391:0
	ashr r2, r8, 16
	.loc	1 391 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:391:0
	#APP
	stw r2, r1[0]
	#NO_APP
	.loc	1 392 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:392:0
	stw r8, dp[packData]
	bu .LBB0_81
.Ltmp97:
...
.Lxtalabel29:
	...
	.loc	1 395 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:395:0
	{
		zext r1, 16
		ldc r2, 11
	}
	...
	.loc	1 396 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:396:0
	ldw r2, dp[g_aud_to_host_dptr]
	.loc	1 396 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:396:0
	#APP
	stw r1, r2[0]
	#NO_APP
	.loc	1 397 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:397:0
	{
		add r1, r2, 4
		nop
	}
	.loc	1 397 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:397:0
	stw r1, dp[g_aud_to_host_dptr]
	.loc	1 398 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:398:0
	stw r8, dp[packData]
	bu .LBB0_81
.Ltmp98:
...
.Lxtalabel30:
	...
	ldw r2, cp[.LCPI0_0]
	.loc	1 401 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:401:0
	{
		and r2, r8, r2
		nop
	}
	...
	.loc	1 401 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:401:0
	stw r1, dp[packData]
	.loc	1 402 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:402:0
	ldw r2, dp[g_aud_to_host_dptr]
	.loc	1 402 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:402:0
	#APP
	stw r1, r2[0]
	#NO_APP
	.loc	1 403 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:403:0
	{
		add r1, r2, 4
		nop
	}
...
.Ltmp103:
	stw r1, dp[packState]
.Ltmp104:
	.loc	1 416 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:416:0
	{
		mov r4, r3
		ldw r9, sp[1]
	}
...
.LBB0_6:
	...
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	.loc	1 359 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:359:0
.Ltmp106:
...
.Ltmp112:
	#DEBUG_VALUE: mult <- R2
	.loc	1 344 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:344:0
	{
		mov r9, r6
		mov r10, r6
	}
	...
	maccs r10, r9, r2, r1
	#NO_APP
	.loc	1 345 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:345:0
	{
		shl r1, r10, 3
		nop
	}
.Ltmp113:
	#DEBUG_VALUE: sample <- R1
	.loc	1 354 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:354:0
	#APP
	stw r1, r8[0]
	#NO_APP
.Ltmp114:
	#DEBUG_VALUE: i <- R7
	.loc	1 355 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:355:0
	{
		add r8, r8, 4
		add r7, r7, 1
	}
...
.Lxtalabel34:
	#DEBUG_VALUE: handle_audio_request:c_mix_out <- R0
	#DEBUG_VALUE: i <- R2
	.loc	1 418 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:418:0
...
.LBB0_47:                               # %ifdone330
.Lxtalabel35:
	.loc	1 421 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:421:0
	...
	.loc	1 427 9                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:427:9
	{
		lss r0, r0, r4
		nop
	}
...
.Lxtalabel36:
	...
	.loc	1 430 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:430:0
.Ltmp125:
	stw r0, dp[packState]
	.loc	1 433 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:433:0
.Ltmp126:
...
.Ltmp127:
	...
	.loc	1 435 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:435:0
	ldw r1, dp[g_aud_to_host_wrptr]
	.loc	1 435 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:435:0
	#APP
	stw r0, r1[0]
	#NO_APP
	.loc	1 441 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:441:0
	{
		add r2, r0, 7
		nop
	}
...
.Ltmp128:
	...
	.loc	1 444 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:444:13
...
.LBB0_50:                               # %iftrue349
.Lxtalabel38:
	.loc	1 446 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:446:0
	stw r6, dp[g_aud_to_host_wrptr]
	.loc	1 449 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:449:0
	{
		add r1, r6, 4
		nop
	}
	.loc	1 449 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:449:0
	stw r1, dp[g_aud_to_host_dptr]
	.loc	1 455 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:455:0
	#APP
	ldw   r1, dp[g_speed]
	#NO_APP
.Ltmp129:
	#DEBUG_VALUE: speed <- R1
	.loc	1 458 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:458:0
	ldw r2, dp[speedRem]
	.loc	1 458 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:458:0
	{
		add r1, r2, r1
...
.Ltmp130:
	.loc	1 459 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:459:0
	ashr r5, r1, 16
	.loc	1 459 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:459:0
	stw r5, dp[totalSampsToWrite]
	.loc	1 460 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:460:0
	{
		zext r1, 16
		nop
	}
	.loc	1 460 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:460:0
	stw r1, dp[speedRem]
	.loc	1 470 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:470:0
...
.Ltmp131:
	...
	.loc	1 473 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:473:13
	{
		lss r2, r11, r4
		eq r1, r1, r8
	}
...
.Ltmp132:
# BB#51:
	.loc	1 475 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:475:0
	{
		sub r11, r7, r6
		nop
	}
...
.LBB0_52:                               # %iftrue349
.Lxtalabel39:
	.loc	1 479 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:479:13
	mul r1, r3, r5
	{
		nop
		ldw r2, sp[3]
...
.LBB0_54:                               # %LoopBody411
                                        # =>This Inner Loop Header: Depth=1
.Lxtalabel40:
	.loc	1 492 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:492:0
.Ltmp134:
	#APP
...
.Ltmp135:
	...
	.loc	1 493 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:493:0
	#APP
	ldw r2, r3[0]
	#NO_APP
.Ltmp136:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 496 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:496:0
	{
		add r2, r2, 7
		nop
	}
...
.Ltmp138:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 499 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:499:0
	{
		add r3, r2, r3
		nop
	}
.Ltmp139:
	.loc	1 500 21                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:500:21
...
.Lxtalabel41:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 502 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:502:0
...
.Lxtalabel42:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 505 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:505:0
	{
		add r11, r2, r11
		nop
	}
.Ltmp142:
	#DEBUG_VALUE: space_left <- R11
	.loc	1 506 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:506:0
	#APP
	stw r3, dp[g_aud_to_host_rdptr]
	#NO_APP
.Ltmp143:
	.loc	1 508 19                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:508:19
	{
		lss r2, r11, r1
		nop
	}
...
# BB#57:                                # %ifdone399.loopexit
	.loc	1 511 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:511:0
	ldw r5, dp[totalSampsToWrite]
.Ltmp146:
	.loc	1 515 5                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:515:5
	ldw r9, dp[outUnderflow]
.LBB0_58:                               # %ifdone399
.Lxtalabel43:
	.loc	1 511 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:511:0
...
# BB#82:                                # %iftrue461
.Lxtalabel46:
	.loc	1 521 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:521:0
	...
	ldw r1, cp[.LCPI0_3]
	.loc	1 522 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:522:0
	{
		and r0, r0, r1
		nop
	}
	.loc	1 525 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:525:0
	ldw r1, dp[g_aud_from_host_rdptr]
	.loc	1 525 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:525:0
	{
		add r0, r0, r1
	...
	.loc	1 527 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:527:0
	stw r1, dp[aud_data_remaining_to_device]
	bu .LBB0_83
.LBB0_62:                               # %iftrue442.ifdone462_crit_edge
	.loc	1 531 9                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:531:9
...
# BB#84:                                # %iftrue475
.Lxtalabel48:
	.loc	1 533 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:533:0
	ldw r0, dp[aud_from_host_fifo_start]
	.loc	1 533 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:533:0
	stw r0, dp[g_aud_from_host_rdptr]
.LBB0_85:                               # %ifdone476
.Lxtalabel49:
	.loc	1 536 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:536:0
	ldw r1, dp[g_aud_from_host_wrptr]
	.loc	1 536 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:536:0
	{
		eq r1, r0, r1
...
# BB#86:                                # %iftrue485
.Lxtalabel50:
	.loc	1 541 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:541:0
	#APP
	ldw r1, r0[0]
	#NO_APP
	.loc	1 541 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:541:0
	...
	.loc	1 543 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:543:0
	stw r1, dp[unpackState]
	.loc	1 545 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:545:0
	{
		add r0, r0, 4
		nop
	}
...
decouple:                               # @decouple
.Lfunc_begin1:
	.loc	1 585 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:585:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel52:
...
.Ltmp163:
	#DEBUG_VALUE: x <- R1
	.loc	1 598 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:598:0
	stw r1, dp[p_multOut]
	.loc	3 13 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\xc_ptr.h:13:0
.Ltmp164:
	ldaw r0, dp[multIn]
...
.Ltmp165:
	#DEBUG_VALUE: x <- R0
	.loc	1 601 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:601:0
	stw r0, dp[p_multIn]
	.loc	1 604 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:604:0
	stw r2, dp[aud_from_host_fifo_start]
	ldc r11, 1632
	.loc	1 605 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:605:0
	{
		add r3, r2, r11
		nop
	}
	...
	.loc	1 606 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:606:0
	stw r2, dp[g_aud_from_host_wrptr]
	.loc	1 607 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:607:0
...
.Ltmp168:
	#DEBUG_VALUE: x <- R2
	#DEBUG_VALUE: t <- R2
	.loc	1 611 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:611:0
	stw r2, dp[aud_to_host_fifo_start]
	.loc	1 612 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:612:0
	{
		add r3, r2, r11
		nop
	}
	...
	.loc	1 613 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:613:0
	stw r2, dp[g_aud_to_host_wrptr]
	.loc	1 614 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:614:0
	stw r2, dp[g_aud_to_host_rdptr]
	.loc	1 615 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:615:0
	{
		add r2, r2, 4
		nop
	}
...
.Ltmp171:
	#DEBUG_VALUE: x <- R2
	#DEBUG_VALUE: t <- R2
	.loc	1 622 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:622:0
...
.Ltmp172:
	...
	.loc	1 628 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:628:0
.Ltmp173:
	#APP
	stw r2, r1[r9]
	#NO_APP
...
.Ltmp174:
	...
	#NO_APP
.Ltmp175:
	.loc	1 635 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:635:0
	#APP
	stw r2, r0[r9]
	#NO_APP
.Ltmp176:
	...
	#NO_APP
.Ltmp177:
	.loc	1 639 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:639:0
	#APP
...
.Lxtalabel53:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 646 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:646:0
	#APP
...
.Lxta.loop_labels8:
	# LOOPMARKER 0
	.loc	1 644 5                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:644:5
	bf r0, .LBB1_1
.Ltmp180:
# BB#2:                                 # %ifdone42
.Lxtalabel54:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 650 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:650:0
	#APP
	stw r9, dp[g_aud_from_host_flag]
	#NO_APP
	.loc	1 653 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:653:0
	ldw r0, dp[g_aud_from_host_wrptr]
	.loc	1 653 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:653:0
	#APP
	stw r0, dp[g_aud_from_host_buffer]
	#NO_APP
	.loc	1 654 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:654:0
	ldw r0, dp[aud_from_host_usb_ep]
.Ltmp181:
	#DEBUG_VALUE: XUD_SetReady_OutPtr:ep <- R0
	.loc	1 654 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:654:0
	ldw r1, dp[g_aud_from_host_wrptr]
	.loc	2 434 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:434:0
.Ltmp182:
	#APP
	ldw r2, r0[9]
	#NO_APP
...
.Ltmp185:
	...
	.loc	2 439 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:439:0
	#APP
	ldw r2, r0[0]
	#NO_APP
.Ltmp186:
	#DEBUG_VALUE: chan_array_ptr <- R2
	.loc	2 440 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:440:0
	#APP
	stw r1, r0[3]
	#NO_APP
	.loc	2 441 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:441:0
	#APP
	stw r0, r2[0]
	#NO_APP
.Ltmp187:
...
.Lxtalabel56:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 661 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:661:0
	#APP
...
.Lxta.loop_labels9:
	# LOOPMARKER 1
	.loc	1 659 5                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:659:5
	bf r0, .LBB1_4
.Ltmp189:
# BB#5:                                 # %ifdone57
.Lxtalabel57:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 665 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:665:0
	#APP
...
.Lxtalabel58:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 876 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:876:0
...
.Lxtalabel59:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 685 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:685:0
	#APP
	#decouple-default
	#NO_APP
	.loc	1 689 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:689:0
	#APP
	ldw r0, dp[g_freqChange_flag]
	#NO_APP
.Ltmp192:
	#DEBUG_VALUE: tmp <- R0
	.loc	1 690 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:690:13
	{
		eq r1, r0, 8
		nop
	}
...
.Lxtalabel61:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 742 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:742:0
	#APP
	clrsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
	.loc	1 743 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:743:0
	#APP
	stw r9, dp[g_freqChange_flag]
	#NO_APP
	.loc	1 745 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:745:0
	#APP
	ldw r0, dp[g_formatChange_NumChans]
	#NO_APP
	.loc	1 745 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:745:0
	stw r0, dp[g_numUsbChan_In]
	.loc	1 746 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:746:0
	#APP
	ldw r0, dp[g_formatChange_SubSlot]
	#NO_APP
	.loc	1 746 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:746:0
	stw r0, dp[g_curSubSlot_In]
	.loc	1 747 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:747:0
	#APP
	ldw r0, dp[g_formatChange_DataFormat]
	#NO_APP
.Ltmp195:
	#DEBUG_VALUE: dataFormat <- R0
	.loc	1 750 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:750:0
	stw r6, dp[inUnderflow]
	.loc	1 751 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:751:0
...
.Ltmp196:
	...
	#NO_APP
	.loc	1 752 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:752:0
	ldw r0, dp[aud_to_host_fifo_start]
	.loc	1 752 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:752:0
	#APP
	stw r0, dp[g_aud_to_host_wrptr]
	#NO_APP
	.loc	1 753 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:753:0
	ldw r0, dp[aud_to_host_fifo_start]
	.loc	1 753 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:753:0
	{
		add r0, r0, 4
	...
	#NO_APP
	.loc	1 756 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:756:0
	ldw r0, dp[g_aud_to_host_zeros]
	.loc	1 756 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:756:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
	#NO_APP
	.loc	1 759 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:759:0
...
.Ltmp198:
	...
	.loc	1 554 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:554:0
	{
		mov r0, r5
		ldaw r1, sp[3]
	}
...
.Lxta.call_labels0:
	bl GetADCCounts
	.loc	1 558 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:558:0
	#APP
	stw r9, dp[sampsToWrite]
	#NO_APP
	.loc	1 559 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:559:0
	#APP
	stw r9, dp[totalSampsToWrite]
	#NO_APP
	.loc	1 561 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:561:0
...
.Ltmp199:
	...
	.loc	1 563 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:563:0
	ldw r1, dp[g_aud_to_host_zeros]
	.loc	1 563 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:563:0
	#APP
	stw r0, r1[0]
	#NO_APP
	.loc	1 570 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:570:0
	#APP
	ldw r1, dp[g_aud_to_host_buffer]
	#NO_APP
.Ltmp200:
	#DEBUG_VALUE: p <- R1
	.loc	2 465 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:465:0
	#APP
	ldw r2, r8[9]
	#NO_APP
.Ltmp201:
...
.Lxtalabel62:
	...
	#DEBUG_VALUE: mid <- R0
	#DEBUG_VALUE: p <- R1
	.loc	1 572 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:572:0
	{
		add r1, r1, 4
		nop
	}
.Ltmp203:
	.loc	2 472 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:472:0
	ashr r2, r0, 2
.Ltmp204:
	#DEBUG_VALUE: wordlength <- R2
	#DEBUG_VALUE: wordlength <- R3
	.loc	2 473 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:473:0
	{
		and r3, r0, r10
		shl r0, r0, 5
	}
.Ltmp205:
	.loc	2 475 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:475:0
	{
		zext r0, 7
		nop
	}
.Ltmp206:
	...
	.loc	2 477 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:477:0
	#APP
	ldw r11, r8[0]
	#NO_APP
.Ltmp207:
	#DEBUG_VALUE: chan_array_ptr <- R11
	.loc	2 480 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:480:0
	#APP
	add r1, r1, r3
	#NO_APP
.Ltmp208:
	#DEBUG_VALUE: tmp <- R1
	.loc	2 482 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:482:0
	#APP
	neg r2, r2
	#NO_APP
.Ltmp209:
	#DEBUG_VALUE: tmp2 <- R2
	.loc	2 485 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:485:0
	#APP
	stw r2, r8[6]
	#NO_APP
	.loc	2 488 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:488:0
	#APP
	stw r1, r8[3]
	#NO_APP
	.loc	2 491 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:491:0
	#APP
	stw r0, r8[7]
	#NO_APP
	.loc	2 493 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:493:0
	#APP
	stw r8, r11[0]
	#NO_APP
.Ltmp210:
.LBB1_18:                               # %SetupZerosSendBuffer.exit342
                                        #   in Loop: Header=BB1_6 Depth=1
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 761 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:761:0
	#APP
	ldw r0, dp[g_curUsbSpeed]
	#NO_APP
.Ltmp211:
	#DEBUG_VALUE: usbSpeed <- R0
	.loc	1 764 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:764:0
	ldw r0, dp[g_numUsbChan_In]
.Ltmp212:
	ldc r1, 196
	.loc	1 764 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:764:0
	...
	.loc	1 771 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:771:0
	#APP
	stw r9, dp[g_freqChange]
	#NO_APP
	.loc	1 772 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:772:0
	ldw r0, dp[buffer_aud_ctl_chan]
	.loc	1 772 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:772:0
	#APP
	outct res[r0],r6
	#NO_APP
	.loc	1 774 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:774:0
	#APP
	setsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
	bu .LBB1_19
...
.Lxtalabel63:
	...
	.loc	1 782 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:782:0
	#APP
	clrsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
	.loc	1 783 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:783:0
	#APP
	stw r9, dp[g_freqChange_flag]
	#NO_APP
	.loc	1 784 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:784:0
	#APP
	ldw r0, dp[g_formatChange_NumChans]
	#NO_APP
	.loc	1 784 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:784:0
	stw r0, dp[g_numUsbChan_Out]
	.loc	1 785 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:785:0
	#APP
	ldw r0, dp[g_formatChange_SubSlot]
	#NO_APP
	.loc	1 785 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:785:0
	stw r0, dp[g_curSubSlot_Out]
	.loc	1 786 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:786:0
	#APP
	ldw r1, dp[g_formatChange_DataFormat]
	#NO_APP
.Ltmp214:
	#DEBUG_VALUE: dataFormat <- R1
	.loc	1 787 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:787:0
	#APP
	ldw r0, dp[g_formatChange_SampRes]
	#NO_APP
.Ltmp215:
	#DEBUG_VALUE: sampRes <- R0
	.loc	1 790 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:790:0
	ldw r2, dp[aud_from_host_fifo_start]
	.loc	1 790 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:790:0
	#APP
	stw r2, dp[g_aud_from_host_rdptr]
	#NO_APP
	.loc	1 791 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:791:0
	ldw r2, dp[aud_from_host_fifo_start]
	.loc	1 791 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:791:0
	#APP
	stw r2, dp[g_aud_from_host_wrptr]
	#NO_APP
	.loc	1 793 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:793:0
	stw r9, dp[unpackState]
	.loc	1 795 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:795:0
	stw r6, dp[outUnderflow]
	.loc	1 796 17                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:796:17
...
.Lxtalabel64:
	...
	#DEBUG_VALUE: dataFormat <- R1
	#DEBUG_VALUE: sampRes <- R0
	.loc	1 799 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:799:0
...
.LBB1_34:                               # %XUD_SetReady_OutPtr.exit346
	...
	#DEBUG_VALUE: dataFormat <- R1
	#DEBUG_VALUE: sampRes <- R0
	.loc	1 800 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:800:0
...
.Lxtalabel66:
	...
	#DEBUG_VALUE: sampRes <- R0
	ldw r2, cp[.LCPI1_1]
	.loc	1 804 17                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:804:17
	{
		eq r1, r1, r2
		nop
	}
...
.Lxta.endpoint_labels10:
	...
	.loc	1 811 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:811:0
.Lxta.endpoint_labels11:
	{
		outct res[r4], 8
		nop
	}
	.loc	1 812 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:812:0
.Lxta.endpoint_labels12:
	{
		out res[r4], r1
		nop
	}
	.loc	1 813 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:813:0
.Lxta.endpoint_labels13:
	{
		out res[r4], r0
		nop
	}
	.loc	1 816 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:816:0
	{
		chkct res[r4], 1
		nop
	}
	.loc	1 817 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:817:0
	ldw r0, dp[buffer_aud_ctl_chan]
.Ltmp226:
	.loc	1 817 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:817:0
	#APP
	outct res[r0],r6
	#NO_APP
	.loc	1 819 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:819:0
	#APP
	stw r9, dp[g_freqChange]
	#NO_APP
	.loc	1 820 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:820:0
	#APP
	setsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
.Ltmp227:
...
.Lxtalabel67:
	...
	#DEBUG_VALUE: aud_from_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 826 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:826:0
	#APP
	ldw r0, dp[g_aud_from_host_flag]
	#NO_APP
.Ltmp228:
	#DEBUG_VALUE: aud_from_host_flag <- R0
	.loc	1 827 9                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:827:9
	bf r0, .LBB1_37
.Ltmp229:
# BB#20:                                # %iftrue148
                                        #   in Loop: Header=BB1_6 Depth=1
.Lxtalabel68:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 834 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:834:0
	#APP
	ldw r0, dp[g_aud_from_host_wrptr]
	#NO_APP
.Ltmp230:
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
	.loc	1 835 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:835:0
	#APP
	ldw r1, dp[g_aud_from_host_rdptr]
	#NO_APP
.Ltmp231:
	#DEBUG_VALUE: aud_from_host_rdptr <- R1
	.loc	1 837 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:837:0
	#APP
	stw r9, dp[g_aud_from_host_flag]
	#NO_APP
	.loc	1 838 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:838:0
	#APP
	ldw r3, dp[g_aud_from_host_buffer]
	#NO_APP
.Ltmp232:
	#DEBUG_VALUE: released_buffer <- R3
	.loc	1 841 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:841:0
	#APP
	ldw r2, r3[0]
	#NO_APP
.Ltmp233:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 844 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:844:13
...
.Lxtalabel70:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 848 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:848:0
	{
		add r2, r2, 3
		nop
	}
...
.Ltmp236:
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
	.loc	1 851 17                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:851:17
...
.Lxtalabel71:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 853 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:853:0
	ldw r0, dp[aud_from_host_fifo_start]
.Ltmp238:
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
.LBB1_24:                               # %iftrue153
...
.Lxtalabel72:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 855 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:855:0
	#APP
...
.Lxtalabel73:
	...
	#DEBUG_VALUE: aud_to_host_flag <- 0
	#DEBUG_VALUE: aud_from_host_rdptr <- R1
	.loc	1 860 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:860:0
	{
		sub r1, r1, r0
		nop
	}
.Ltmp240:
	...
	.loc	1 863 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:863:13
	{
		lss r2, r1, r6
		nop
	}
...
.Lxtalabel75:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 865 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:865:0
	ldw r1, dp[aud_from_host_fifo_end]
	.loc	1 865 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:865:0
...
.Lxtalabel76:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 868 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:868:13
	{
		sub r1, r1, 1
		nop
	}
...
.Lxtalabel77:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 870 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:870:0
	#APP
	stw r0, dp[g_aud_from_host_buffer]
	#NO_APP
	.loc	1 871 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:871:0
...
.Lxtalabel79:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 884 14                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:884:14
...
.Lxtalabel80:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 889 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:889:0
	#APP
	ldw r0, dp[g_aud_from_host_wrptr]
	#NO_APP
.Ltmp252:
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
	.loc	1 890 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:890:0
	#APP
	ldw r1, dp[g_aud_from_host_rdptr]
	#NO_APP
.Ltmp253:
	#DEBUG_VALUE: aud_from_host_rdptr <- R1
	.loc	1 891 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:891:0
	{
		sub r1, r1, r0
		nop
	}
.Ltmp254:
	#DEBUG_VALUE: space_left <- R1
	.loc	1 892 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:892:13
	{
		lss r2, r1, r6
		nop
	}
...
# BB#39:                                #   in Loop: Header=BB1_6 Depth=1
	...
	#DEBUG_VALUE: space_left <- R1
	ldc r2, 1632
	.loc	1 893 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:893:0
	{
		add r1, r1, r2
		nop
	}
...
.Lxtalabel81:
	...
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
	ldc r2, 815
	.loc	1 894 13                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:894:13
	{
		lss r1, r2, r1
		nop
	}
...
.Lxtalabel82:
	...
	#DEBUG_VALUE: aud_to_host_flag <- 0
	#DEBUG_VALUE: aud_from_host_wrptr <- R0
	.loc	1 897 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:897:0
	stw r9, dp[outOverflow]
	.loc	1 898 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:898:0
	#APP
	stw r0, dp[g_aud_from_host_buffer]
	#NO_APP
	.loc	1 899 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:899:0
	ldw r1, dp[aud_from_host_usb_ep]
.Ltmp258:
	#DEBUG_VALUE: XUD_SetReady_OutPtr:ep <- R1
	.loc	2 434 0                 # C:/Projects/UI-01_sw1_hw1/module_xud/include\xud.h:434:0
...
.Lxtalabel84:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 911 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:911:0
	#APP
	ldw r0, dp[g_aud_to_host_flag]
	#NO_APP
.Ltmp264:
...
.Lxtalabel85:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 917 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:917:0
	#APP
	stw r9, dp[g_aud_to_host_flag]
	#NO_APP
	.loc	1 919 17                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:919:17
	ldw r2, dp[inUnderflow]
	.loc	1 924 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:924:0
.Ltmp266:
	#APP
	ldw r1, dp[g_aud_to_host_wrptr]
	#NO_APP
.Ltmp267:
	...
	#DEBUG_VALUE: aud_to_host_wrptr <- R1
	.loc	1 950 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:950:0
	#APP
...
.Lxtalabel86:
	...
	#DEBUG_VALUE: aud_to_host_wrptr <- R1
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
	.loc	1 928 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:928:0
	{
		sub r1, r1, r0
		nop
	}
.Ltmp270:
	...
	.loc	1 930 21                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:930:21
	ashr r2, r1, 32
	bf r2, .LBB1_45
.Ltmp271:
# BB#44:                                #   in Loop: Header=BB1_6 Depth=1
	...
	#DEBUG_VALUE: fill_level <- R1
	ldc r2, 1632
	.loc	1 931 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:931:0
	{
		add r1, r1, r2
		nop
	}
...
.Lxtalabel87:
	...
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
	ldc r2, 415
	.loc	1 933 21                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:933:21
	{
		lss r1, r2, r1
		nop
	}
...
.Lxtalabel88:
	...
	#DEBUG_VALUE: aud_to_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
	.loc	1 935 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:935:0
	stw r9, dp[inUnderflow]
	.loc	1 936 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:936:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
	#NO_APP
	bu .LBB1_47
...
.Lxtalabel89:
	...
	#DEBUG_VALUE: aud_to_host_wrptr <- R1
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
	.loc	1 953 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:953:0
	#APP
	ldw r2, r0[0]
	#NO_APP
.Ltmp275:
	#DEBUG_VALUE: datalength <- R2
	.loc	1 954 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:954:0
	{
		add r2, r2, 3
		nop
	}
...
.Ltmp278:
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
	.loc	1 955 21                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:955:21
...
.Lxtalabel90:
	...
	#DEBUG_VALUE: aud_to_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_wrptr <- R1
	.loc	1 957 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:957:0
	ldw r0, dp[aud_to_host_fifo_start]
.Ltmp280:
	#DEBUG_VALUE: aud_to_host_rdptr <- R0
.LBB1_53:                               # %iffalse266
...
.Lxtalabel91:
	...
	#DEBUG_VALUE: aud_to_host_flag <- 0
	#DEBUG_VALUE: aud_to_host_wrptr <- R1
	.loc	1 959 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:959:0
	#APP
	stw r0, dp[g_aud_to_host_rdptr]
	#NO_APP
	.loc	1 962 21                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:962:21
	{
		eq r1, r0, r1
		nop
	}
...
.Lxtalabel92:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 968 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:968:0
	stw r6, dp[inUnderflow]
	.loc	1 969 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:969:0
	ldw r0, dp[g_aud_to_host_zeros]
	.loc	1 969 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:969:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
...
.Lxtalabel93:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 940 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:940:0
	ldw r0, dp[g_aud_to_host_zeros]
	.loc	1 940 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:940:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
...
.Lxtalabel95:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	.loc	1 692 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:692:0
	#APP
	stw r9, dp[g_freqChange_flag]
	#NO_APP
	.loc	1 693 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:693:0
	#APP
...
.Ltmp286:
	...
	.loc	1 697 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:697:0
	#APP
	clrsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
	.loc	1 698 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:698:0
.Lxta.endpoint_labels14:
	{
		in r0, res[r4]
		nop
	}
	.loc	1 699 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:699:0
.Lxta.endpoint_labels15:
	{
		outct res[r4], 4
		nop
	}
	.loc	1 700 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:700:0
.Lxta.endpoint_labels16:
	{
		out res[r4], r5
		nop
	}
	.loc	1 702 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:702:0
	stw r6, dp[inUnderflow]
	.loc	1 703 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:703:0
	ldw r0, dp[aud_to_host_fifo_start]
	.loc	1 703 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:703:0
	#APP
	stw r0, dp[g_aud_to_host_rdptr]
	#NO_APP
	.loc	1 704 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:704:0
	ldw r0, dp[aud_to_host_fifo_start]
	.loc	1 704 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:704:0
	#APP
	stw r0, dp[g_aud_to_host_wrptr]
	#NO_APP
	.loc	1 705 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:705:0
	ldw r0, dp[aud_to_host_fifo_start]
	.loc	1 705 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:705:0
	{
		add r0, r0, 4
	...
	stw r0, dp[g_aud_to_host_dptr]
	#NO_APP
	.loc	1 708 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:708:0
	ldw r0, dp[g_aud_to_host_zeros]
	.loc	1 708 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:708:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
	#NO_APP
	.loc	1 711 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:711:0
	ldw r8, dp[aud_to_host_usb_ep]
.Ltmp287:
	#DEBUG_VALUE: SetupZerosSendBuffer:aud_to_host_usb_ep <- R8
	#DEBUG_VALUE: XUD_SetReady_InPtr:ep <- R8
...
.LBB1_11:                               # %SetupZerosSendBuffer.exit
	...
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	#DEBUG_VALUE: sampFreq <- R5
	.loc	1 714 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:714:0
	stw r6, dp[outUnderflow]
	.loc	1 715 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:715:0
	ldw r0, dp[aud_from_host_fifo_start]
	.loc	1 715 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:715:0
	#APP
	stw r0, dp[g_aud_from_host_rdptr]
	#NO_APP
	.loc	1 716 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:716:0
	ldw r0, dp[aud_from_host_fifo_start]
	.loc	1 716 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:716:0
	#APP
	stw r0, dp[g_aud_from_host_wrptr]
	#NO_APP
	.loc	1 717 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:717:0
	#APP
	stw r9, dp[aud_data_remaining_to_device]
	#NO_APP
	.loc	1 719 17                # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:719:17
	ldw r0, dp[outOverflow]
	bf r0, .LBB1_15
.Ltmp301:
# BB#12:                                # %iftrue89
...
.Lxtalabel97:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	#DEBUG_VALUE: sampFreq <- R5
	.loc	1 722 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:722:0
	ldw r0, dp[aud_from_host_usb_ep]
.Ltmp302:
	#DEBUG_VALUE: XUD_SetReady_OutPtr:ep <- R0
	.loc	1 722 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:722:0
...
.LBB1_14:                               # %XUD_SetReady_OutPtr.exit327
	...
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	#DEBUG_VALUE: sampFreq <- R5
	.loc	1 723 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:723:0
	stw r9, dp[outOverflow]
.Ltmp309:
.LBB1_15:                               # %ifdone90
                                        #   in Loop: Header=BB1_6 Depth=1
.Lxtalabel99:
	#DEBUG_VALUE: decouple:c_mix_out <- R4
	#DEBUG_VALUE: sampFreq <- R5
	.loc	1 727 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:727:0
	{
		chkct res[r4], 1
		nop
	}
	.loc	1 729 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:729:0
	#APP
	stw r9, dp[g_freqChange]
	#NO_APP
	.loc	1 730 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:730:0
	ldw r0, dp[buffer_aud_ctl_chan]
	.loc	1 730 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:730:0
	#APP
	outct res[r0],r6
	#NO_APP
	.loc	1 732 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:732:0
	#APP
	setsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))
	#NO_APP
	.loc	1 734 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:734:0
	stw r9, dp[speedRem]
	bu .LBB1_6
.Ltmp310:
.LBB1_54:                               # %iftrue310
...
.Lxtalabel100:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 964 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:964:0
	#APP
	stw r0, dp[g_aud_to_host_buffer]
	#NO_APP
.Ltmp311:
...
.Lxtalabel101:
	...
	#DEBUG_VALUE: sampFreq <- 44100
	#DEBUG_VALUE: aud_to_host_flag <- 0
	.loc	1 976 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:976:0
	#APP
	ldw r2, dp[g_aud_to_host_buffer]
	#NO_APP
.Ltmp312:
	#DEBUG_VALUE: p <- R2
	.loc	1 977 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:977:0
	#APP
	ldw r1, r2[0]
	#NO_APP
.Ltmp313:
	...
	.loc	1 978 0                 # C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc:978:0
...
.Linfo_string1:
.asciiz"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxta.call_labels0
	.ascii	"C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer/decouple.xc"
	.byte	0
	.long	554
...
.cc_top cc_516,.Lxtalabel77
	.ascii	"C:/Projects/UI-01_sw1_hw1/module_xud/include\\xud.h"
	.byte	0
	.long	429
	.long	431
	.long	.Lxtalabel77
