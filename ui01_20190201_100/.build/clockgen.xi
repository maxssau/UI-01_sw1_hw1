# 1 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
...
# 3 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
...
# 4 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
...
# 5 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
...
# 7 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
...
# 8 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc" 2
# 24 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
...
# 200 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
...
void clockGen (streaming chanend ?c_spdif_rx, chanend ?c_adat_rx, out port p, chanend c_dig_rx, chanend c_clk_ctl, chanend c_clk_int)
{
    ...
    int smux = 0;
# 254 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
    for(int i = 0; i < 10; i++)
    {
       g_digData[i] = 0;
    }
# 266 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
    clockFreq[(1 - 1)] = 0;
    clockId[(1 - 1)] = 41;
    clockValid[(1 - 1)] = 0;
    clockInt[(1 - 1)] = 0;
# 295 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
    t_local :> timeNextEdge;
    timeLastEdge = timeNextEdge;
    timeNextClockDetection = timeNextEdge + (166667 / 2);
    timeNextEdge += 166667;
# 311 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
    p <: pinVal @ pinTime;
    ...
    while(1)
    {
        select
        {
# 357 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
...
# 396 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
                        break;
       ...
       break;
            ...
            case t_local when __builtin_timer_after(timeNextEdge) :> void:
                ...
                timeNextClockDetection = timeNextEdge + (166667/2);
                timeNextEdge += 166667;
# 472 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
                break;
# 824 "F:/Projects/UI-01_sw1_hw1/module_usb_audio/clocking/clockgen.xc"
        }
