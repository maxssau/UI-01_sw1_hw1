	.text
	.file	"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
	...
	.set usage.anon.5,0
	.set usage.anon.6,0
	.globread device_reboot_aux,tile,"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:30: note: object used here\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~"
	...
	.globpassesref get_tile_id, tile,"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:18: error: call to `get_tile_id\' in `device_reboot_aux\' makes alias of global \'tile\'\n        tileId = get_tile_id(tile[i]);\n                 ^~~~~~~~~~~~~~~~~~~~"
...
.Lfunc_begin0:
	.file	2 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
	.loc	2 21 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:21:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp1:
	.cfi_offset 15, 0
	.loc	2 32 0 prologue_end     # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:32:0
.Ltmp2:
...
.Ltmp7:
	...
	.loc	2 37 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:37:0
	#APP
...
.Lxtalabel1:
	...
	#DEBUG_VALUE: tileArrayLength <- R7
	#DEBUG_VALUE: i <- 0
	.loc	2 43 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:0
	ldaw r11, cp[tile]
	.loc	2 43 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:0
	{
		ldc r0, 0
...
.Ltmp10:
	...
	.loc	2 46 9                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:46:9
	{
		eq r0, r4, r5
		nop
	}
...
.Ltmp12:
	.loc	2 48 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:48:0
	{
		mov r0, r5
		mov r1, r6
	}
.Lxta.call_labels2:
	...
	ldw r1, cp[.LCPI0_0]
	.loc	2 49 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:49:0
	{
		and r2, r0, r1
		nop
	}
.Ltmp13:
	...
	.loc	2 50 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:50:0
	{
		mov r1, r6
		nop
	}
...
.Lxtalabel3:
	...
	.loc	2 40 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:40:0
	{
		lsu r0, r0, r7
		nop
	}
...
.Ltmp16:
	.loc	2 55 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:55:0
	{
		mov r0, r4
		mov r1, r5
	}
...
.Ltmp17:
	#DEBUG_VALUE: pllVal <- R2
	.loc	2 56 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:56:0
	{
		and r2, r0, r1
		mov r0, r4
	}
.Ltmp18:
	.loc	2 57 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:57:0
	{
		mov r1, r5
		nop
	}
...
.Ltmp20:
	...
	.set	device_reboot_aux.nstackwords,((get_local_tile_id.nstackwords $M get_tile_id.nstackwords $M read_sswitch_reg.nstackwords $M write_sswitch_reg_no_ack.nstackwords) + 6)
...
.Ltmp21:
	.size	device_reboot_aux, .Ltmp21-device_reboot_aux
.Lfunc_end0:
	.cfi_endproc
...
.Lfunc_begin1:
	.loc	2 63 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:63:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel5:
...
.Lxta.endpoint_labels0:
	...
	.loc	2 66 0 prologue_end     # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:66:0
.Ltmp24:
.Lxta.endpoint_labels1:
	...
	.loc	2 69 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:69:0
	#APP
	freer res[r0]
	#NO_APP
	.loc	2 71 0                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:71:0
.Lxta.call_labels6:
	bl device_reboot_aux
.Ltmp25:
.LBB1_1:                                # %LoopTest
                                        # =>This Inner Loop Header: Depth=1
	.loc	2 73 5                  # /home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:73:5
	bu .LBB1_1
.Ltmp26:
...
.Ltmp27:
	.size	device_reboot, .Ltmp27-device_reboot
.Lfunc_end1:
	.cfi_endproc
...
.Linfo_string1:
.asciiz"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
.Linfo_string2:
...
.Ldebug_loc0:
	.long	.Ltmp7
	.long	.Ltmp19
.Lset0 = .Ltmp29-.Ltmp28                # Loc expr size
	.short	.Lset0
.Ltmp28:
	.byte	84                      # DW_OP_reg4
.Ltmp29:
...
.Ldebug_loc1:
	.long	.Ltmp8
	.long	.Ltmp14
.Lset1 = .Ltmp31-.Ltmp30                # Loc expr size
	.short	.Lset1
.Ltmp30:
...
.Ltmp31:
	.long	.Ltmp14
	.long	.Lfunc_end0
.Lset2 = .Ltmp33-.Ltmp32                # Loc expr size
	.short	.Lset2
.Ltmp32:
	.byte	17                      # DW_OP_consts
	.byte	1                       # 
...
.Ldebug_loc2:
	.long	.Ltmp8
	.long	.Ltmp15
.Lset3 = .Ltmp35-.Ltmp34                # Loc expr size
	.short	.Lset3
.Ltmp34:
	.byte	87                      # DW_OP_reg7
.Ltmp35:
...
.Ldebug_loc3:
	.long	.Ltmp10
	.long	.Ltmp14
.Lset4 = .Ltmp37-.Ltmp36                # Loc expr size
	.short	.Lset4
.Ltmp36:
	.byte	85                      # DW_OP_reg5
.Ltmp37:
...
.Ldebug_loc4:
	.long	.Ltmp11
	.long	.Ltmp12
.Lset5 = .Ltmp39-.Ltmp38                # Loc expr size
	.short	.Lset5
.Ltmp38:
...
.Ltmp39:
	.long	.Ltmp13
	.long	.Ltmp14
.Lset6 = .Ltmp41-.Ltmp40                # Loc expr size
	.short	.Lset6
.Ltmp40:
	.byte	82                      # DW_OP_reg2
.Ltmp41:
...
.cc_top cc_0,.Lxta.call_labels0
	.ascii	"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
	.byte	0
	.long	32
...
.Ltrap_info_str0:
.asciiz"/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:30: error: out of bounds array access\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~\n"
	.section	.trap_info,"",@progbits
