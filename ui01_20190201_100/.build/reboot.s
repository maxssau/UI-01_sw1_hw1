	.text
	.file	"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
	...
	.set usage.anon.5,0
	.set usage.anon.6,0
	.globread device_reboot_aux,tile,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:30: note: object used here\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~"
	...
	.globpassesref get_tile_id, tile,"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:18: error: call to `get_tile_id\' in `device_reboot_aux\' makes alias of global \'tile\'\n        tileId = get_tile_id(tile[i]);\n                 ^~~~~~~~~~~~~~~~~~~~"
...
.Lfunc_begin0:
	.file	2 "C:/Projects/UI-01_sw1_hw1/module_usb_audio\\reboot.xc"
	.loc	2 21 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:21:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp1:
	.cfi_offset 15, 0
	.loc	2 32 0 prologue_end     # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:32:0
.Ltmp2:
...
.Ltmp7:
	...
	.loc	2 37 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:37:0
	#APP
...
.Lxtalabel1:
	...
	#DEBUG_VALUE: tileArrayLength <- R7
	#DEBUG_VALUE: i <- 0
	.loc	2 43 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:0
	ldaw r11, cp[tile]
	.loc	2 43 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:0
	{
		ldc r0, 0
...
.Ltmp10:
	...
	.loc	2 46 9                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:46:9
	{
		eq r0, r4, r5
		nop
	}
...
.Ltmp12:
	.loc	2 48 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:48:0
	{
		mov r0, r5
		mov r1, r6
	}
.Lxta.call_labels2:
	...
	ldw r1, cp[.LCPI0_0]
	.loc	2 49 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:49:0
	{
		and r2, r0, r1
		nop
	}
.Ltmp13:
	...
	.loc	2 50 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:50:0
	{
		mov r1, r6
		nop
	}
...
.Lxtalabel3:
	...
	.loc	2 40 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:40:0
	{
		lsu r0, r0, r7
		nop
	}
...
.Ltmp16:
	.loc	2 55 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:55:0
	{
		mov r0, r4
		mov r1, r5
	}
...
.Ltmp17:
	#DEBUG_VALUE: pllVal <- R2
	.loc	2 56 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:56:0
	{
		and r2, r0, r1
		mov r0, r4
	}
.Ltmp18:
	.loc	2 57 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:57:0
	{
		mov r1, r5
		nop
	}
...
.Lfunc_begin1:
	.loc	2 63 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:63:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel5:
...
.Lxta.endpoint_labels0:
	...
	.loc	2 66 0 prologue_end     # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:66:0
.Ltmp24:
.Lxta.endpoint_labels1:
	...
	.loc	2 69 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:69:0
	#APP
	freer res[r0]
	#NO_APP
	.loc	2 71 0                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:71:0
.Lxta.call_labels6:
	bl device_reboot_aux
.Ltmp25:
.LBB1_1:                                # %LoopTest
                                        # =>This Inner Loop Header: Depth=1
	.loc	2 73 5                  # C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:73:5
	bu .LBB1_1
.Ltmp26:
...
.Linfo_string1:
.asciiz"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxta.call_labels0
	.ascii	"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc"
	.byte	0
	.long	32
...
.Ltrap_info_str0:
.asciiz"C:/Projects/UI-01_sw1_hw1/module_usb_audio/reboot.xc:43:30: error: out of bounds array access\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~\n"
	.section	.trap_info,"",@progbits
