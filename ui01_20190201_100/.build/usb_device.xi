# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc" 2
...
# 9 "C:/Projects/UI-01_sw1_hw1/module_xud/include\\xud.h" 2
...
# 7 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc" 2
...
# 10 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src\\usb_device.h" 2
...
# 8 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc" 2
...
# 9 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc" 2

# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\string.h" 1 3
...
# 54 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\string.h" 3
...
# 5 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\string.h" 2 3
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\safe/string.h" 1 3



# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\string.h" 1 3
# 5 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\safe/string.h" 2 3
...
# 6 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include/xc\\string.h" 2 3
# 11 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc" 2
# 24 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc"
unsigned char g_currentConfig = 0;
unsigned char g_interfaceAlt[16];

unsigned short g_epStatusOut[(2 + 2)];
unsigned short g_epStatusIn[(2 + 2)];
        ...
        case ((0 << 7) | (0x00 << 5) | (0x00)):
            ...
            switch(sp.bRequest)
            {
                ...
                case 0x09:
                    ...
                    {
# 163 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc"
...
# 607 "C:/Projects/UI-01_sw1_hw1/module_usb_device/src/usb_device.xc"
    XUD_SetStall(ep_out);
    XUD_SetStall(ep_in);
    return XUD_RES_ERR;
}
