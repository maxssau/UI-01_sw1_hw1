# 1 "/home/evgeny/git/104/UI-01_sw1_hw1/lib_i2c/src/i2c_master_ext.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/evgeny/git/104/UI-01_sw1_hw1/lib_i2c/src/i2c_master_ext.xc" 2
...
void i2c_slave(client i2c_slave_callback_if i,
               port p_scl, port p_sda,
               uint8_t device_addr);
# 3 "/home/evgeny/git/104/UI-01_sw1_hw1/lib_i2c/src/i2c_master_ext.xc" 2
