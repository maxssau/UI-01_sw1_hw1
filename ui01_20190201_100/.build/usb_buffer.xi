# 1 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 3 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 4 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 6 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
# 15 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
...
# 16 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 17 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 18 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
# 1 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/testct_byref.h" 1
...
# 19 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 41 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
unsigned g_speed;
unsigned g_freqChange = 0;
# 83 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
unsigned char fb_clocks[16];
# 97 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
void buffer(register chanend c_aud_out, register chanend c_aud_in,
# 124 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
            chanend c_sof,
            chanend c_aud_ctl,
            in port p_off_mclk
...
# 162 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
    unsigned u_tmp;
...
# 226 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
...
# 261 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
    while(1)
    {
        XUD_Result_t result;
        unsigned length;
        ...
        select
        {
# 295 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
            case testct_byref(c_aud_ctl, u_tmp):
            {
                ...
                else
                {
                    ...
                    else if (cmd == 8)
                    {
                        ...
                        asm volatile("stw %0, dp[" "g_formatChange_DataFormat" "]"::"r"(formatChange_DataFormat):"memory");
                        asm volatile("stw %0, dp[" "g_formatChange_SampRes" "]"::"r"(formatChange_SampRes):"memory");
# 386 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
                    }
...
# 477 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
            ...
            break;
# 576 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
            case XUD_GetData_Select(c_aud_out, ep_aud_out, length, result):
            {
                ...
                break;
# 941 "/home/evgeny/git/104/UI-01_sw1_hw1/module_usb_audio/usb_buffer/usb_buffer.xc"
        }
