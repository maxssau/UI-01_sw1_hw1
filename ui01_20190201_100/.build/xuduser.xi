# 1 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
...
# 2 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
...
# 3 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
...
# 1 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src\\customdefines.h" 1
...
# 4 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/hostactive\\hostactive.h" 1

void UserHostActive(int active);
# 5 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
...
# 6 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2


# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\hwtimer.h" 1 3
# 26 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.2\\target/include\\hwtimer.h" 3
typedef [[hwtimer]] timer hwtimer_t;
# 9 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
# 1 "C:/Projects/UI-01_sw1_hw1/module_usb_audio/usb_buffer\\interrupt.h" 1
# 10 "C:/Projects/UI-01_sw1_hw1/ui01_20190201_100/src/xuduser.xc" 2
...
void XUD_UserSuspend(void)
{
    ...
    asm volatile("setc res[%0], %1"::"r"(g_rebootTimer),"r"(0x1));
    g_rebootTimer :> time;
    time += 20000000;

    asm volatile("setd res[%0], %1"::"r"(g_rebootTimer),"r"(time));
    asm volatile("setc res[%0], %1"::"r"(g_rebootTimer),"r"(0x9));

    asm("ldaw r11, dp[__" "HandleRebootTimeout" "_kernel_stack_end];ldaw r10, sp[0]; " "set sp,r11;stw r10, sp[0]; krestsp 0":::"r10","r11"); asm("kentsp 20; stw %0, sp[1]; stw %1, sp[2]; krestsp 20"::"r"(g_rebootTimer),"r"(0)); asm("ldap r11, __" "HandleRebootTimeout" "_handler; setv res[%0],r11"::"r"(g_rebootTimer):"r11"); asm("setc res[%0], 0xa; eeu res[%0]"::"r"(g_rebootTimer)); asm("setsr (((0) & ~(((1 << 0x1) - 1) << 0x1)) | (((1) << 0x1) & (((1 << 0x1) - 1) << 0x1)))");
}
